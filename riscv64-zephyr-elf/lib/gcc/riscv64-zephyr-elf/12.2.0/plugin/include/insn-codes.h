...
enum insn_code {
  ...
  CODE_FOR_bswaphi2 = 487,
  CODE_FOR_mem_thread_fence = 488,
  CODE_FOR_atomic_compare_and_swapsi = 489,
  CODE_FOR_atomic_compare_and_swapdi = 490,
  CODE_FOR_atomic_test_and_set = 491
};

const unsigned int NUM_INSN_CODES = 492;
