...
ENTRY(_start)
SEARCH_DIR("=/__w/_temp/workspace/output/xtensa-mtk_mt8195_adsp_zephyr-elf/xtensa-mtk_mt8195_adsp_zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
