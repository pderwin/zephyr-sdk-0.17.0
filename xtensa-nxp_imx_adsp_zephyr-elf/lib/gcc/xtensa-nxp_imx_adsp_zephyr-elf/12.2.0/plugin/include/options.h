...
#define MASK_AUTO_LITPOOLS (1U << 0)
#define MASK_CONST16 (1U << 1)
#define MASK_FORCE_NO_PIC (1U << 2)
#define MASK_SERIALIZE_VOLATILE (1U << 3)
...
enum opt_code
{
  ...
  OPT_list = 1763,                           /* -list */
  OPT_mabi_call0 = 1764,                     /* -mabi=call0 */
  OPT_mabi_windowed = 1765,                  /* -mabi=windowed */
  OPT_mauto_litpools = 1766,                 /* -mauto-litpools */
  OPT_mconst16 = 1767,                       /* -mconst16 */
  OPT_mforce_no_pic = 1768,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1769, */              /* -mfused-madd */
  OPT_mlongcalls = 1770,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1771,            /* -mserialize-volatile */
  OPT_mtarget_align = 1772,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1773,         /* -mtext-section-literals */
  OPT_n = 1774,                              /* -n */
  OPT_name_sort = 1775,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1776,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1777,              /* -no-integrated-cpp */
  OPT_no_pie = 1778,                         /* -no-pie */
  OPT_nocpp = 1779,                          /* -nocpp */
  OPT_nodefaultlibs = 1780,                  /* -nodefaultlibs */
  OPT_nolibc = 1781,                         /* -nolibc */
  OPT_nophoboslib = 1782,                    /* -nophoboslib */
  OPT_nostartfiles = 1783,                   /* -nostartfiles */
  OPT_nostdinc = 1784,                       /* -nostdinc */
  OPT_nostdinc__ = 1785,                     /* -nostdinc++ */
  OPT_nostdlib = 1786,                       /* -nostdlib */
  OPT_o = 1787,                              /* -o */
  OPT_objects = 1788,                        /* -objects */
  OPT_p = 1789,                              /* -p */
  OPT_pass_exit_codes = 1790,                /* -pass-exit-codes */
  /* OPT_pedantic = 1791, */                 /* -pedantic */
  OPT_pedantic_errors = 1792,                /* -pedantic-errors */
  OPT_pg = 1793,                             /* -pg */
  OPT_pie = 1794,                            /* -pie */
  OPT_pipe = 1795,                           /* -pipe */
  OPT_print_file_name_ = 1796,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1797,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1798,          /* -print-multi-directory */
  OPT_print_multi_lib = 1799,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1800,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1801,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1802,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1803,               /* -print-prog-name= */
  OPT_print_search_dirs = 1804,              /* -print-search-dirs */
  OPT_print_sysroot = 1805,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1806,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1807,                    /* -print-value */
  OPT_quiet = 1808,                          /* -quiet */
  OPT_r = 1809,                              /* -r */
  OPT_rdynamic = 1810,                       /* -rdynamic */
  OPT_remap = 1811,                          /* -remap */
  OPT_reverse_sort = 1812,                   /* -reverse-sort */
  OPT_s = 1813,                              /* -s */
  OPT_save_temps = 1814,                     /* -save-temps */
  OPT_save_temps_ = 1815,                    /* -save-temps= */
  OPT_shared = 1816,                         /* -shared */
  OPT_shared_libgcc = 1817,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1818,               /* -shared-libphobos */
  OPT_size_sort = 1819,                      /* -size-sort */
  /* OPT_specs = 1820, */                    /* -specs */
  OPT_specs_ = 1821,                         /* -specs= */
  OPT_static = 1822,                         /* -static */
  OPT_static_libasan = 1823,                 /* -static-libasan */
  OPT_static_libgcc = 1824,                  /* -static-libgcc */
  OPT_static_libgfortran = 1825,             /* -static-libgfortran */
  OPT_static_libgo = 1826,                   /* -static-libgo */
  OPT_static_libhwasan = 1827,               /* -static-libhwasan */
  OPT_static_liblsan = 1828,                 /* -static-liblsan */
  OPT_static_libmpx = 1829,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1830,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1831,               /* -static-libphobos */
  OPT_static_libstdc__ = 1832,               /* -static-libstdc++ */
  OPT_static_libtsan = 1833,                 /* -static-libtsan */
  OPT_static_libubsan = 1834,                /* -static-libubsan */
  OPT_static_pie = 1835,                     /* -static-pie */
  /* OPT_std_c__03 = 1836, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1837, */                /* -std=c++0x */
  OPT_std_c__11 = 1838,                      /* -std=c++11 */
  OPT_std_c__14 = 1839,                      /* -std=c++14 */
  OPT_std_c__17 = 1840,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1841, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1842, */                /* -std=c++1z */
  OPT_std_c__20 = 1843,                      /* -std=c++20 */
  OPT_std_c__23 = 1844,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1845, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1846, */                /* -std=c++2b */
  OPT_std_c__98 = 1847,                      /* -std=c++98 */
  OPT_std_c11 = 1848,                        /* -std=c11 */
  OPT_std_c17 = 1849,                        /* -std=c17 */
  /* OPT_std_c18 = 1850, */                  /* -std=c18 */
  /* OPT_std_c1x = 1851, */                  /* -std=c1x */
  OPT_std_c2x = 1852,                        /* -std=c2x */
  /* OPT_std_c89 = 1853, */                  /* -std=c89 */
  OPT_std_c90 = 1854,                        /* -std=c90 */
  OPT_std_c99 = 1855,                        /* -std=c99 */
  /* OPT_std_c9x = 1856, */                  /* -std=c9x */
  OPT_std_f2003 = 1857,                      /* -std=f2003 */
  OPT_std_f2008 = 1858,                      /* -std=f2008 */
  OPT_std_f2008ts = 1859,                    /* -std=f2008ts */
  OPT_std_f2018 = 1860,                      /* -std=f2018 */
  OPT_std_f95 = 1861,                        /* -std=f95 */
  OPT_std_gnu = 1862,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1863, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1864, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1865,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1866,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1867,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1868, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1869, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1870,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1871,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1872, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1873, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1874,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1875,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1876,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1877, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1878, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1879,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1880, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1881,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1882,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1883, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1884, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1885,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1886, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1887, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1888, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1889, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1890, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1891,                     /* -std=legacy */
  OPT_stdlib_ = 1892,                        /* -stdlib= */
  OPT_symbol_ = 1893,                        /* -symbol= */
  OPT_symbolic = 1894,                       /* -symbolic */
  OPT_t = 1895,                              /* -t */
  OPT_time = 1896,                           /* -time */
  OPT_time_ = 1897,                          /* -time= */
  OPT_traditional = 1898,                    /* -traditional */
  OPT_traditional_cpp = 1899,                /* -traditional-cpp */
  OPT_tree_stats = 1900,                     /* -tree-stats */
  OPT_trigraphs = 1901,                      /* -trigraphs */
  OPT_type_stats = 1902,                     /* -type-stats */
  OPT_u = 1903,                              /* -u */
  OPT_undef = 1904,                          /* -undef */
  OPT_v = 1905,                              /* -v */
  OPT_version = 1906,                        /* -version */
  OPT_w = 1907,                              /* -w */
  OPT_wrapper = 1908,                        /* -wrapper */
  OPT_x = 1909,                              /* -x */
  OPT_z = 1910,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
