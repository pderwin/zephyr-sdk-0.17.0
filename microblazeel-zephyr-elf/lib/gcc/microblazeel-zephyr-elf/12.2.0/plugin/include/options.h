...
#endif
#ifdef GENERATOR_FILE
extern const char *microblaze_select_cpu;
#else
  const char *x_microblaze_select_cpu;
#define microblaze_select_cpu global_options.x_microblaze_select_cpu
#endif
#ifdef GENERATOR_FILE
extern int TARGET_REORDER;
#else
  int x_TARGET_REORDER;
#define TARGET_REORDER global_options.x_TARGET_REORDER
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mxl_mode_xilkernel;
#define x_VAR_mxl_mode_xilkernel do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_MB_64 (1U << 0)
#define MASK_LITTLE_ENDIAN (1U << 1)
#define MASK_SOFT_FLOAT (1U << 2)
#define MASK_MEMCPY (1U << 3)
#define MASK_PIC_DATA_TEXT_REL (1U << 4)
#define MASK_SMALL_DIVIDES (1U << 5)
#define MASK_BARREL_SHIFT (1U << 6)
#define MASK_FLOAT_CONVERT (1U << 7)
#define MASK_FLOAT_SQRT (1U << 8)
#define MASK_AREA_OPTIMIZED_2 (1U << 9)
#define MASK_XLGPOPT (1U << 10)
#define MASK_XL_MODE_BOOTSTRAP (1U << 11)
#define MASK_XL_MODE_EXECUTABLE (1U << 12)
#define MASK_XL_MODE_NOVECTORS (1U << 13)
#define MASK_XL_MODE_XMDSTUB (1U << 14)
#define MASK_MULTIPLY_HIGH (1U << 15)
#define MASK_PATTERN_COMPARE (1U << 16)
#define MASK_PREFETCH (1U << 17)
#define MASK_SOFT_DIV (1U << 18)
#define MASK_SOFT_MUL (1U << 19)
#define MASK_STACK_CHECK (1U << 20)

/* MB_64 mask */
#define TARGET_MB_64 ((target_flags & MASK_MB_64) != 0)
#define TARGET_MB_64_P(target_flags) (((target_flags) & MASK_MB_64) != 0)
#define TARGET_EXPLICIT_MB_64_P(opts) ((opts->x_target_flags_explicit & MASK_MB_64) != 0)
#define SET_TARGET_MB_64(opts) opts->x_target_flags |= MASK_MB_64
/* LITTLE_ENDIAN mask */
#define TARGET_LITTLE_ENDIAN ((target_flags & MASK_LITTLE_ENDIAN) != 0)
#define TARGET_LITTLE_ENDIAN_P(target_flags) (((target_flags) & MASK_LITTLE_ENDIAN) != 0)
#define TARGET_EXPLICIT_LITTLE_ENDIAN_P(opts) ((opts->x_target_flags_explicit & MASK_LITTLE_ENDIAN) != 0)
#define SET_TARGET_LITTLE_ENDIAN(opts) opts->x_target_flags |= MASK_LITTLE_ENDIAN
/* SOFT_FLOAT mask */
#define TARGET_SOFT_FLOAT ((target_flags & MASK_SOFT_FLOAT) != 0)
#define TARGET_SOFT_FLOAT_P(target_flags) (((target_flags) & MASK_SOFT_FLOAT) != 0)
#define TARGET_EXPLICIT_SOFT_FLOAT_P(opts) ((opts->x_target_flags_explicit & MASK_SOFT_FLOAT) != 0)
#define SET_TARGET_SOFT_FLOAT(opts) opts->x_target_flags |= MASK_SOFT_FLOAT
/* MEMCPY mask */
...
/* PIC_DATA_TEXT_REL mask */
#define TARGET_PIC_DATA_TEXT_REL ((target_flags & MASK_PIC_DATA_TEXT_REL) != 0)
#define TARGET_PIC_DATA_TEXT_REL_P(target_flags) (((target_flags) & MASK_PIC_DATA_TEXT_REL) != 0)
#define TARGET_EXPLICIT_PIC_DATA_TEXT_REL_P(opts) ((opts->x_target_flags_explicit & MASK_PIC_DATA_TEXT_REL) != 0)
#define SET_TARGET_PIC_DATA_TEXT_REL(opts) opts->x_target_flags |= MASK_PIC_DATA_TEXT_REL
/* SMALL_DIVIDES mask */
#define TARGET_SMALL_DIVIDES ((target_flags & MASK_SMALL_DIVIDES) != 0)
#define TARGET_SMALL_DIVIDES_P(target_flags) (((target_flags) & MASK_SMALL_DIVIDES) != 0)
#define TARGET_EXPLICIT_SMALL_DIVIDES_P(opts) ((opts->x_target_flags_explicit & MASK_SMALL_DIVIDES) != 0)
#define SET_TARGET_SMALL_DIVIDES(opts) opts->x_target_flags |= MASK_SMALL_DIVIDES
/* BARREL_SHIFT mask */
#define TARGET_BARREL_SHIFT ((target_flags & MASK_BARREL_SHIFT) != 0)
#define TARGET_BARREL_SHIFT_P(target_flags) (((target_flags) & MASK_BARREL_SHIFT) != 0)
#define TARGET_EXPLICIT_BARREL_SHIFT_P(opts) ((opts->x_target_flags_explicit & MASK_BARREL_SHIFT) != 0)
#define SET_TARGET_BARREL_SHIFT(opts) opts->x_target_flags |= MASK_BARREL_SHIFT
/* FLOAT_CONVERT mask */
#define TARGET_FLOAT_CONVERT ((target_flags & MASK_FLOAT_CONVERT) != 0)
#define TARGET_FLOAT_CONVERT_P(target_flags) (((target_flags) & MASK_FLOAT_CONVERT) != 0)
#define TARGET_EXPLICIT_FLOAT_CONVERT_P(opts) ((opts->x_target_flags_explicit & MASK_FLOAT_CONVERT) != 0)
#define SET_TARGET_FLOAT_CONVERT(opts) opts->x_target_flags |= MASK_FLOAT_CONVERT
/* FLOAT_SQRT mask */
#define TARGET_FLOAT_SQRT ((target_flags & MASK_FLOAT_SQRT) != 0)
#define TARGET_FLOAT_SQRT_P(target_flags) (((target_flags) & MASK_FLOAT_SQRT) != 0)
#define TARGET_EXPLICIT_FLOAT_SQRT_P(opts) ((opts->x_target_flags_explicit & MASK_FLOAT_SQRT) != 0)
#define SET_TARGET_FLOAT_SQRT(opts) opts->x_target_flags |= MASK_FLOAT_SQRT
/* AREA_OPTIMIZED_2 mask */
#define TARGET_AREA_OPTIMIZED_2 ((target_flags & MASK_AREA_OPTIMIZED_2) != 0)
#define TARGET_AREA_OPTIMIZED_2_P(target_flags) (((target_flags) & MASK_AREA_OPTIMIZED_2) != 0)
#define TARGET_EXPLICIT_AREA_OPTIMIZED_2_P(opts) ((opts->x_target_flags_explicit & MASK_AREA_OPTIMIZED_2) != 0)
#define SET_TARGET_AREA_OPTIMIZED_2(opts) opts->x_target_flags |= MASK_AREA_OPTIMIZED_2
/* XLGPOPT mask */
#define TARGET_XLGPOPT ((target_flags & MASK_XLGPOPT) != 0)
#define TARGET_XLGPOPT_P(target_flags) (((target_flags) & MASK_XLGPOPT) != 0)
#define TARGET_EXPLICIT_XLGPOPT_P(opts) ((opts->x_target_flags_explicit & MASK_XLGPOPT) != 0)
#define SET_TARGET_XLGPOPT(opts) opts->x_target_flags |= MASK_XLGPOPT
/* XL_MODE_BOOTSTRAP mask */
#define TARGET_XL_MODE_BOOTSTRAP ((target_flags & MASK_XL_MODE_BOOTSTRAP) != 0)
#define TARGET_XL_MODE_BOOTSTRAP_P(target_flags) (((target_flags) & MASK_XL_MODE_BOOTSTRAP) != 0)
#define TARGET_EXPLICIT_XL_MODE_BOOTSTRAP_P(opts) ((opts->x_target_flags_explicit & MASK_XL_MODE_BOOTSTRAP) != 0)
#define SET_TARGET_XL_MODE_BOOTSTRAP(opts) opts->x_target_flags |= MASK_XL_MODE_BOOTSTRAP
/* XL_MODE_EXECUTABLE mask */
#define TARGET_XL_MODE_EXECUTABLE ((target_flags & MASK_XL_MODE_EXECUTABLE) != 0)
#define TARGET_XL_MODE_EXECUTABLE_P(target_flags) (((target_flags) & MASK_XL_MODE_EXECUTABLE) != 0)
#define TARGET_EXPLICIT_XL_MODE_EXECUTABLE_P(opts) ((opts->x_target_flags_explicit & MASK_XL_MODE_EXECUTABLE) != 0)
#define SET_TARGET_XL_MODE_EXECUTABLE(opts) opts->x_target_flags |= MASK_XL_MODE_EXECUTABLE
/* XL_MODE_NOVECTORS mask */
#define TARGET_XL_MODE_NOVECTORS ((target_flags & MASK_XL_MODE_NOVECTORS) != 0)
#define TARGET_XL_MODE_NOVECTORS_P(target_flags) (((target_flags) & MASK_XL_MODE_NOVECTORS) != 0)
#define TARGET_EXPLICIT_XL_MODE_NOVECTORS_P(opts) ((opts->x_target_flags_explicit & MASK_XL_MODE_NOVECTORS) != 0)
#define SET_TARGET_XL_MODE_NOVECTORS(opts) opts->x_target_flags |= MASK_XL_MODE_NOVECTORS
/* XL_MODE_XMDSTUB mask */
#define TARGET_XL_MODE_XMDSTUB ((target_flags & MASK_XL_MODE_XMDSTUB) != 0)
#define TARGET_XL_MODE_XMDSTUB_P(target_flags) (((target_flags) & MASK_XL_MODE_XMDSTUB) != 0)
#define TARGET_EXPLICIT_XL_MODE_XMDSTUB_P(opts) ((opts->x_target_flags_explicit & MASK_XL_MODE_XMDSTUB) != 0)
#define SET_TARGET_XL_MODE_XMDSTUB(opts) opts->x_target_flags |= MASK_XL_MODE_XMDSTUB
/* MULTIPLY_HIGH mask */
#define TARGET_MULTIPLY_HIGH ((target_flags & MASK_MULTIPLY_HIGH) != 0)
#define TARGET_MULTIPLY_HIGH_P(target_flags) (((target_flags) & MASK_MULTIPLY_HIGH) != 0)
#define TARGET_EXPLICIT_MULTIPLY_HIGH_P(opts) ((opts->x_target_flags_explicit & MASK_MULTIPLY_HIGH) != 0)
#define SET_TARGET_MULTIPLY_HIGH(opts) opts->x_target_flags |= MASK_MULTIPLY_HIGH
/* PATTERN_COMPARE mask */
#define TARGET_PATTERN_COMPARE ((target_flags & MASK_PATTERN_COMPARE) != 0)
#define TARGET_PATTERN_COMPARE_P(target_flags) (((target_flags) & MASK_PATTERN_COMPARE) != 0)
#define TARGET_EXPLICIT_PATTERN_COMPARE_P(opts) ((opts->x_target_flags_explicit & MASK_PATTERN_COMPARE) != 0)
#define SET_TARGET_PATTERN_COMPARE(opts) opts->x_target_flags |= MASK_PATTERN_COMPARE
/* PREFETCH mask */
#define TARGET_PREFETCH ((target_flags & MASK_PREFETCH) != 0)
#define TARGET_PREFETCH_P(target_flags) (((target_flags) & MASK_PREFETCH) != 0)
#define TARGET_EXPLICIT_PREFETCH_P(opts) ((opts->x_target_flags_explicit & MASK_PREFETCH) != 0)
#define SET_TARGET_PREFETCH(opts) opts->x_target_flags |= MASK_PREFETCH
/* SOFT_DIV mask */
...
/* STACK_CHECK mask */
#define TARGET_STACK_CHECK ((target_flags & MASK_STACK_CHECK) != 0)
#define TARGET_STACK_CHECK_P(target_flags) (((target_flags) & MASK_STACK_CHECK) != 0)
#define TARGET_EXPLICIT_STACK_CHECK_P(opts) ((opts->x_target_flags_explicit & MASK_STACK_CHECK) != 0)
#define SET_TARGET_STACK_CHECK(opts) opts->x_target_flags |= MASK_STACK_CHECK
...
enum opt_code
{
  ...
  OPT_Z = 843,                               /* -Z */
  OPT_Zxl_mode_bootstrap = 844,              /* -Zxl-mode-bootstrap */
  OPT_Zxl_mode_executable = 845,             /* -Zxl-mode-executable */
  OPT_Zxl_mode_novectors = 846,              /* -Zxl-mode-novectors */
  OPT_Zxl_mode_xilkernel = 847,              /* -Zxl-mode-xilkernel */
  OPT_Zxl_mode_xmdstub = 848,                /* -Zxl-mode-xmdstub */
  OPT_ansi = 849,                            /* -ansi */
  ...
  OPT_fdump_analyzer_untracked = 1100,       /* -fdump-analyzer-untracked */
  ...
  OPT_ffold_simple_inlines = 1153,           /* -ffold-simple-inlines */
  ...
  OPT_frevert_dip1000 = 1483,                /* -frevert=dip1000 */
  OPT_frevert_dip25 = 1484,                  /* -frevert=dip25 */
  OPT_frevert_dtorfields = 1485,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1486,             /* -frevert=intpromote */
  OPT_frevert_markdown = 1487,               /* -frevert=markdown */
  OPT_frounding_math = 1488,                 /* -frounding-math */
  OPT_frtti = 1489,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1490,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1491,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1492,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1493,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1494,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1495,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1496,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1497,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1498,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1499, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1500,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1501,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1502,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1503,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1504,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1505,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1506,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1507,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1508,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1509,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1510,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1511,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1512,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1513,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1514,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1515,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1516, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1517,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1518,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1519,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1520,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1521,               /* -fsection-anchors */
  /* OPT_fsee = 1522, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1523,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1524,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1525,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1526,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1527,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1528,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1529,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1530,                   /* -fshort-enums */
  OPT_fshort_wchar = 1531,                   /* -fshort-wchar */
  OPT_fshow_column = 1532,                   /* -fshow-column */
  OPT_fshrink_wrap = 1533,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1534,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1535,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1536,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1537,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1538,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1539,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1540,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1541,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1542,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1543,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1544,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1545,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1546,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1547,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1548,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1549,                      /* -fsquangle */
  OPT_fssa_backprop = 1550,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1551,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1552,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1553,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1554, */             /* -fstack-check */
  OPT_fstack_check_ = 1555,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1556,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1557,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1558,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1559,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1560,               /* -fstack-protector */
  OPT_fstack_protector_all = 1561,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1562,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1563,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1564,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1565,                   /* -fstack-usage */
  OPT_fstats = 1566,                         /* -fstats */
  OPT_fstdarg_opt = 1567,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1568,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1569, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1570,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1571,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1572,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1573,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1574,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1575, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1576,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1577,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1578,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1579,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1580,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1581, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1582,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1583, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1584,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1585, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1586,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1587,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1588,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1589,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1590,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1591,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1592,                   /* -ftime-report */
  OPT_ftime_report_details = 1593,           /* -ftime-report-details */
  OPT_ftls_model_ = 1594,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1595,              /* -ftoplevel-reorder */
  OPT_ftracer = 1596,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1597,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1598,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1599,                   /* -ftrampolines */
  OPT_ftransition_all = 1600,                /* -ftransition=all */
  OPT_ftransition_field = 1601,              /* -ftransition=field */
  OPT_ftransition_in = 1602,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1603,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1604,          /* -ftransition=templates */
  OPT_ftransition_tls = 1605,                /* -ftransition=tls */
  OPT_ftransition_vmarkdown = 1606,          /* -ftransition=vmarkdown */
  OPT_ftrapping_math = 1607,                 /* -ftrapping-math */
  OPT_ftrapv = 1608,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1609,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1610,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1611,                      /* -ftree-ccp */
  OPT_ftree_ch = 1612,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1613, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1614,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1615,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1616, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1617,                   /* -ftree-cselim */
  OPT_ftree_dce = 1618,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1619,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1620,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1621,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1622,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1623, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1624,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1625,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1626, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1627,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1628,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1629, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1630,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1631,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1632,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1633,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1634,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1635,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1636,                      /* -ftree-pre */
  OPT_ftree_pta = 1637,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1638,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1639, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1640,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1641,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1642,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1643,                     /* -ftree-slsr */
  OPT_ftree_sra = 1644,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1645, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1646, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1647,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1648,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1649,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1650, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1651,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1652, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1653,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1654,        /* -ftrivial-auto-var-init= */
  OPT_funconstrained_commons = 1655,         /* -funconstrained-commons */
  OPT_funderscoring = 1656,                  /* -funderscoring */
  OPT_funit_at_a_time = 1657,                /* -funit-at-a-time */
  OPT_funittest = 1658,                      /* -funittest */
  OPT_funroll_all_loops = 1659,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1660,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1661,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1662, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1663,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1664,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1665,                 /* -funsigned-char */
  OPT_funswitch_loops = 1666,                /* -funswitch-loops */
  OPT_funwind_tables = 1667,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1668,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1669,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1670,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1671,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1672,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1673,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1674,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1675,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1676,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1677,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1678,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1679,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1680, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1681,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1682,                   /* -fverbose-asm */
  /* OPT_fversion = 1683, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1684,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1685,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1686,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1687,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1688,                   /* -fvisibility= */
  OPT_fvpt = 1689,                           /* -fvpt */
  OPT_fvtable_gc = 1690,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1691,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1692,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1693,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1694,                     /* -fvtv-debug */
  OPT_fweak = 1695,                          /* -fweak */
  OPT_fweak_templates = 1696,                /* -fweak-templates */
  OPT_fweb = 1697,                           /* -fweb */
  /* OPT_fwhole_file = 1698, */              /* -fwhole-file */
  OPT_fwhole_program = 1699,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1700,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1701,             /* -fworking-directory */
  OPT_fwpa = 1702,                           /* -fwpa */
  OPT_fwpa_ = 1703,                          /* -fwpa= */
  OPT_fwrapv = 1704,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1705,                 /* -fwrapv-pointer */
  OPT_fxref = 1706,                          /* -fxref */
  /* OPT_fzee = 1707, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1708,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1709,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1710,                     /* -fzero-link */
  OPT_g = 1711,                              /* -g */
  OPT_gant = 1712,                           /* -gant */
  OPT_gas_loc_support = 1713,                /* -gas-loc-support */
  OPT_gas_locview_support = 1714,            /* -gas-locview-support */
  OPT_gbtf = 1715,                           /* -gbtf */
  OPT_gcoff = 1716,                          /* -gcoff */
  OPT_gcoff1 = 1717,                         /* -gcoff1 */
  OPT_gcoff2 = 1718,                         /* -gcoff2 */
  OPT_gcoff3 = 1719,                         /* -gcoff3 */
  OPT_gcolumn_info = 1720,                   /* -gcolumn-info */
  OPT_gctf = 1721,                           /* -gctf */
  OPT_gdescribe_dies = 1722,                 /* -gdescribe-dies */
  OPT_gdwarf = 1723,                         /* -gdwarf */
  OPT_gdwarf_ = 1724,                        /* -gdwarf- */
  OPT_gdwarf32 = 1725,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1726,                       /* -gdwarf64 */
  OPT_gen_decls = 1727,                      /* -gen-decls */
  OPT_ggdb = 1728,                           /* -ggdb */
  OPT_ggnu_pubnames = 1729,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1730,                   /* -gimple-stats */
  OPT_ginline_points = 1731,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1732, /* -ginternal-reset-location-views */
  OPT_gnat = 1733,                           /* -gnat */
  OPT_gnatO = 1734,                          /* -gnatO */
  OPT_gno_ = 1735,                           /* -gno- */
  OPT_gno_pubnames = 1736,                   /* -gno-pubnames */
  OPT_gpubnames = 1737,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1738,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1739,                   /* -gsplit-dwarf */
  OPT_gstabs = 1740,                         /* -gstabs */
  OPT_gstabs_ = 1741,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1742,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1743,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1744,                        /* -gtoggle */
  OPT_gvariable_location_views = 1745,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1746,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1747,                           /* -gvms */
  OPT_gxcoff = 1748,                         /* -gxcoff */
  OPT_gxcoff_ = 1749,                        /* -gxcoff+ */
  OPT_gz = 1750,                             /* -gz */
  OPT_gz_ = 1751,                            /* -gz= */
  OPT_h = 1752,                              /* -h */
  OPT_help = 1753,                           /* -help */
  OPT_idirafter = 1754,                      /* -idirafter */
  OPT_imacros = 1755,                        /* -imacros */
  OPT_imultiarch = 1756,                     /* -imultiarch */
  OPT_imultilib = 1757,                      /* -imultilib */
  OPT_include = 1758,                        /* -include */
  OPT_iplugindir_ = 1759,                    /* -iplugindir= */
  OPT_iprefix = 1760,                        /* -iprefix */
  OPT_iquote = 1761,                         /* -iquote */
  OPT_isysroot = 1762,                       /* -isysroot */
  OPT_isystem = 1763,                        /* -isystem */
  OPT_iwithprefix = 1764,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1765,              /* -iwithprefixbefore */
  OPT_k8 = 1766,                             /* -k8 */
  OPT_l = 1767,                              /* -l */
  OPT_lang_asm = 1768,                       /* -lang-asm */
  OPT_list = 1769,                           /* -list */
  OPT_m64 = 1770,                            /* -m64 */
  OPT_mbig_endian = 1771,                    /* -mbig-endian */
  OPT_mcpu_ = 1772,                          /* -mcpu= */
  OPT_mhard_float = 1773,                    /* -mhard-float */
  OPT_mlittle_endian = 1774,                 /* -mlittle-endian */
  OPT_mmemcpy = 1775,                        /* -mmemcpy */
  OPT_mno_clearbss = 1776,                   /* -mno-clearbss */
  OPT_mpic_data_is_text_relative = 1777,     /* -mpic-data-is-text-relative */
  OPT_msmall_divides = 1778,                 /* -msmall-divides */
  OPT_msoft_float = 1779,                    /* -msoft-float */
  OPT_mxl_barrel_shift = 1780,               /* -mxl-barrel-shift */
  OPT_mxl_float_convert = 1781,              /* -mxl-float-convert */
  OPT_mxl_float_sqrt = 1782,                 /* -mxl-float-sqrt */
  OPT_mxl_frequency = 1783,                  /* -mxl-frequency */
  OPT_mxl_gp_opt = 1784,                     /* -mxl-gp-opt */
  OPT_mxl_mode_bootstrap = 1785,             /* -mxl-mode-bootstrap */
  OPT_mxl_mode_executable = 1786,            /* -mxl-mode-executable */
  OPT_mxl_mode_novectors = 1787,             /* -mxl-mode-novectors */
  OPT_mxl_mode_xilkernel = 1788,             /* -mxl-mode-xilkernel */
  OPT_mxl_mode_xmdstub = 1789,               /* -mxl-mode-xmdstub */
  OPT_mxl_multiply_high = 1790,              /* -mxl-multiply-high */
  OPT_mxl_pattern_compare = 1791,            /* -mxl-pattern-compare */
  OPT_mxl_prefetch = 1792,                   /* -mxl-prefetch */
  OPT_mxl_reorder = 1793,                    /* -mxl-reorder */
  OPT_mxl_soft_div = 1794,                   /* -mxl-soft-div */
  OPT_mxl_soft_mul = 1795,                   /* -mxl-soft-mul */
  OPT_mxl_stack_check = 1796,                /* -mxl-stack-check */
  OPT_n = 1797,                              /* -n */
  OPT_name_sort = 1798,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1799,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1800,              /* -no-integrated-cpp */
  OPT_no_pie = 1801,                         /* -no-pie */
  OPT_nocpp = 1802,                          /* -nocpp */
  OPT_nodefaultlibs = 1803,                  /* -nodefaultlibs */
  OPT_nolibc = 1804,                         /* -nolibc */
  OPT_nophoboslib = 1805,                    /* -nophoboslib */
  OPT_nostartfiles = 1806,                   /* -nostartfiles */
  OPT_nostdinc = 1807,                       /* -nostdinc */
  OPT_nostdinc__ = 1808,                     /* -nostdinc++ */
  OPT_nostdlib = 1809,                       /* -nostdlib */
  OPT_o = 1810,                              /* -o */
  OPT_objects = 1811,                        /* -objects */
  OPT_p = 1812,                              /* -p */
  OPT_pass_exit_codes = 1813,                /* -pass-exit-codes */
  /* OPT_pedantic = 1814, */                 /* -pedantic */
  OPT_pedantic_errors = 1815,                /* -pedantic-errors */
  OPT_pg = 1816,                             /* -pg */
  OPT_pie = 1817,                            /* -pie */
  OPT_pipe = 1818,                           /* -pipe */
  OPT_print_file_name_ = 1819,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1820,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1821,          /* -print-multi-directory */
  OPT_print_multi_lib = 1822,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1823,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1824,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1825,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1826,               /* -print-prog-name= */
  OPT_print_search_dirs = 1827,              /* -print-search-dirs */
  OPT_print_sysroot = 1828,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1829,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1830,                    /* -print-value */
  OPT_quiet = 1831,                          /* -quiet */
  OPT_r = 1832,                              /* -r */
  OPT_remap = 1833,                          /* -remap */
  OPT_reverse_sort = 1834,                   /* -reverse-sort */
  OPT_s = 1835,                              /* -s */
  OPT_save_temps = 1836,                     /* -save-temps */
  OPT_save_temps_ = 1837,                    /* -save-temps= */
  OPT_shared = 1838,                         /* -shared */
  OPT_shared_libgcc = 1839,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1840,               /* -shared-libphobos */
  OPT_size_sort = 1841,                      /* -size-sort */
  /* OPT_specs = 1842, */                    /* -specs */
  OPT_specs_ = 1843,                         /* -specs= */
  OPT_static = 1844,                         /* -static */
  OPT_static_libasan = 1845,                 /* -static-libasan */
  OPT_static_libgcc = 1846,                  /* -static-libgcc */
  OPT_static_libgfortran = 1847,             /* -static-libgfortran */
  OPT_static_libgo = 1848,                   /* -static-libgo */
  OPT_static_libhwasan = 1849,               /* -static-libhwasan */
  OPT_static_liblsan = 1850,                 /* -static-liblsan */
  OPT_static_libmpx = 1851,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1852,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1853,               /* -static-libphobos */
  OPT_static_libstdc__ = 1854,               /* -static-libstdc++ */
  OPT_static_libtsan = 1855,                 /* -static-libtsan */
  OPT_static_libubsan = 1856,                /* -static-libubsan */
  OPT_static_pie = 1857,                     /* -static-pie */
  /* OPT_std_c__03 = 1858, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1859, */                /* -std=c++0x */
  OPT_std_c__11 = 1860,                      /* -std=c++11 */
  OPT_std_c__14 = 1861,                      /* -std=c++14 */
  OPT_std_c__17 = 1862,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1863, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1864, */                /* -std=c++1z */
  OPT_std_c__20 = 1865,                      /* -std=c++20 */
  OPT_std_c__23 = 1866,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1867, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1868, */                /* -std=c++2b */
  OPT_std_c__98 = 1869,                      /* -std=c++98 */
  OPT_std_c11 = 1870,                        /* -std=c11 */
  OPT_std_c17 = 1871,                        /* -std=c17 */
  /* OPT_std_c18 = 1872, */                  /* -std=c18 */
  /* OPT_std_c1x = 1873, */                  /* -std=c1x */
  OPT_std_c2x = 1874,                        /* -std=c2x */
  /* OPT_std_c89 = 1875, */                  /* -std=c89 */
  OPT_std_c90 = 1876,                        /* -std=c90 */
  OPT_std_c99 = 1877,                        /* -std=c99 */
  /* OPT_std_c9x = 1878, */                  /* -std=c9x */
  OPT_std_f2003 = 1879,                      /* -std=f2003 */
  OPT_std_f2008 = 1880,                      /* -std=f2008 */
  OPT_std_f2008ts = 1881,                    /* -std=f2008ts */
  OPT_std_f2018 = 1882,                      /* -std=f2018 */
  OPT_std_f95 = 1883,                        /* -std=f95 */
  OPT_std_gnu = 1884,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1885, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1886, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1887,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1888,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1889,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1890, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1891, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1892,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1893,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1894, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1895, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1896,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1897,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1898,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1899, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1900, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1901,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1902, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1903,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1904,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1905, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1906, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1907,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1908, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1909, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1910, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1911, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1912, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1913,                     /* -std=legacy */
  OPT_stdlib_ = 1914,                        /* -stdlib= */
  OPT_symbol_ = 1915,                        /* -symbol= */
  OPT_symbolic = 1916,                       /* -symbolic */
  OPT_t = 1917,                              /* -t */
  OPT_time = 1918,                           /* -time */
  OPT_time_ = 1919,                          /* -time= */
  OPT_traditional = 1920,                    /* -traditional */
  OPT_traditional_cpp = 1921,                /* -traditional-cpp */
  OPT_tree_stats = 1922,                     /* -tree-stats */
  OPT_trigraphs = 1923,                      /* -trigraphs */
  OPT_type_stats = 1924,                     /* -type-stats */
  OPT_u = 1925,                              /* -u */
  OPT_undef = 1926,                          /* -undef */
  OPT_v = 1927,                              /* -v */
  OPT_version = 1928,                        /* -version */
  OPT_w = 1929,                              /* -w */
  OPT_wrapper = 1930,                        /* -wrapper */
  OPT_x = 1931,                              /* -x */
  OPT_z = 1932,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
