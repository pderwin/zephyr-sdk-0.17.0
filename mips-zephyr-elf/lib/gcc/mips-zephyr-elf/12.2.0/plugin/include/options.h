...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_CRC;
#else
  int x_TARGET_CRC;
#define TARGET_CRC global_options.x_TARGET_CRC
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_GINV;
#else
  int x_TARGET_GINV;
#define TARGET_GINV global_options.x_TARGET_GINV
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_LOONGSON_EXT2;
#else
  int x_TARGET_LOONGSON_EXT2;
#define TARGET_LOONGSON_EXT2 global_options.x_TARGET_LOONGSON_EXT2
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_UNALIGNED_ACCESS;
#else
  int x_TARGET_UNALIGNED_ACCESS;
#define TARGET_UNALIGNED_ACCESS global_options.x_TARGET_UNALIGNED_ACCESS
#endif
#ifdef GENERATOR_FILE
...
#define MASK_LOONGSON_MMI (1U << 20)
#define MASK_MEMCPY (1U << 21)
#define MASK_MICROMIPS (1U << 22)
#define MASK_MSA (1U << 23)
#define MASK_ODD_SPREG (1U << 24)
#define MASK_PAIRED_SINGLE_FLOAT (1U << 25)
#define MASK_RELAX_PIC_CALLS (1U << 26)
#define MASK_SMARTMIPS (1U << 27)
#define MASK_SPLIT_ADDRESSES (1U << 28)
#define MASK_SYNCI (1U << 29)
#define MASK_VR4130_ALIGN (1U << 30)

/* ABICALLS mask */
#define TARGET_ABICALLS ((target_flags & MASK_ABICALLS) != 0)
#define TARGET_ABICALLS_P(target_flags) (((target_flags) & MASK_ABICALLS) != 0)
#define TARGET_EXPLICIT_ABICALLS_P(opts) ((opts->x_target_flags_explicit & MASK_ABICALLS) != 0)
#define SET_TARGET_ABICALLS(opts) opts->x_target_flags |= MASK_ABICALLS
/* BRANCHLIKELY mask */
...
#define TARGET_EXPLICIT_BRANCHLIKELY_P(opts) ((opts->x_target_flags_explicit & MASK_BRANCHLIKELY) != 0)
#define SET_TARGET_BRANCHLIKELY(opts) opts->x_target_flags |= MASK_BRANCHLIKELY
/* CHECK_ZERO_DIV mask */
...
#define TARGET_EXPLICIT_CHECK_ZERO_DIV_P(opts) ((opts->x_target_flags_explicit & MASK_CHECK_ZERO_DIV) != 0)
#define SET_TARGET_CHECK_ZERO_DIV(opts) opts->x_target_flags |= MASK_CHECK_ZERO_DIV
/* DIVIDE_BREAKS mask */
...
#define TARGET_EXPLICIT_DIVIDE_BREAKS_P(opts) ((opts->x_target_flags_explicit & MASK_DIVIDE_BREAKS) != 0)
#define SET_TARGET_DIVIDE_BREAKS(opts) opts->x_target_flags |= MASK_DIVIDE_BREAKS
/* SINGLE_FLOAT mask */
...
#define TARGET_EXPLICIT_SINGLE_FLOAT_P(opts) ((opts->x_target_flags_explicit & MASK_SINGLE_FLOAT) != 0)
#define SET_TARGET_SINGLE_FLOAT(opts) opts->x_target_flags |= MASK_SINGLE_FLOAT
/* BIG_ENDIAN mask */
...
#define TARGET_EXPLICIT_FIX_R10000_P(opts) ((opts->x_target_flags_explicit & MASK_FIX_R10000) != 0)
#define SET_TARGET_FIX_R10000(opts) opts->x_target_flags |= MASK_FIX_R10000
/* FIX_R4000 mask */
...
#define TARGET_EXPLICIT_FIX_R4000_P(opts) ((opts->x_target_flags_explicit & MASK_FIX_R4000) != 0)
#define SET_TARGET_FIX_R4000(opts) opts->x_target_flags |= MASK_FIX_R4000
/* FIX_R4400 mask */
...
#define TARGET_EXPLICIT_FIX_R4400_P(opts) ((opts->x_target_flags_explicit & MASK_FIX_R4400) != 0)
#define SET_TARGET_FIX_R4400(opts) opts->x_target_flags |= MASK_FIX_R4400
/* FIX_R5900 mask */
#define TARGET_FIX_R5900 ((target_flags & MASK_FIX_R5900) != 0)
#define TARGET_FIX_R5900_P(target_flags) (((target_flags) & MASK_FIX_R5900) != 0)
#define TARGET_EXPLICIT_FIX_R5900_P(opts) ((opts->x_target_flags_explicit & MASK_FIX_R5900) != 0)
#define SET_TARGET_FIX_R5900(opts) opts->x_target_flags |= MASK_FIX_R5900
/* FLOAT64 mask */
#define TARGET_FLOAT64 ((target_flags & MASK_FLOAT64) != 0)
#define TARGET_FLOAT64_P(target_flags) (((target_flags) & MASK_FLOAT64) != 0)
#define TARGET_EXPLICIT_FLOAT64_P(opts) ((opts->x_target_flags_explicit & MASK_FLOAT64) != 0)
#define SET_TARGET_FLOAT64(opts) opts->x_target_flags |= MASK_FLOAT64
/* FLOATXX mask */
#define TARGET_FLOATXX ((target_flags & MASK_FLOATXX) != 0)
#define TARGET_FLOATXX_P(target_flags) (((target_flags) & MASK_FLOATXX) != 0)
#define TARGET_EXPLICIT_FLOATXX_P(opts) ((opts->x_target_flags_explicit & MASK_FLOATXX) != 0)
#define SET_TARGET_FLOATXX(opts) opts->x_target_flags |= MASK_FLOATXX
/* 64BIT mask */
#define TARGET_64BIT ((target_flags & MASK_64BIT) != 0)
#define TARGET_64BIT_P(target_flags) (((target_flags) & MASK_64BIT) != 0)
#define TARGET_EXPLICIT_64BIT_P(opts) ((opts->x_target_flags_explicit & MASK_64BIT) != 0)
#define SET_TARGET_64BIT(opts) opts->x_target_flags |= MASK_64BIT
/* SOFT_FLOAT_ABI mask */
...
#define TARGET_EXPLICIT_SOFT_FLOAT_ABI_P(opts) ((opts->x_target_flags_explicit & MASK_SOFT_FLOAT_ABI) != 0)
#define SET_TARGET_SOFT_FLOAT_ABI(opts) opts->x_target_flags |= MASK_SOFT_FLOAT_ABI
/* IMADD mask */
#define TARGET_IMADD ((target_flags & MASK_IMADD) != 0)
#define TARGET_IMADD_P(target_flags) (((target_flags) & MASK_IMADD) != 0)
#define TARGET_EXPLICIT_IMADD_P(opts) ((opts->x_target_flags_explicit & MASK_IMADD) != 0)
#define SET_TARGET_IMADD(opts) opts->x_target_flags |= MASK_IMADD
/* MIPS16 mask */
#define TARGET_MIPS16 ((target_flags & MASK_MIPS16) != 0)
#define TARGET_MIPS16_P(target_flags) (((target_flags) & MASK_MIPS16) != 0)
#define TARGET_EXPLICIT_MIPS16_P(opts) ((opts->x_target_flags_explicit & MASK_MIPS16) != 0)
#define SET_TARGET_MIPS16(opts) opts->x_target_flags |= MASK_MIPS16
/* LLSC mask */
#define TARGET_LLSC ((target_flags & MASK_LLSC) != 0)
#define TARGET_LLSC_P(target_flags) (((target_flags) & MASK_LLSC) != 0)
#define TARGET_EXPLICIT_LLSC_P(opts) ((opts->x_target_flags_explicit & MASK_LLSC) != 0)
#define SET_TARGET_LLSC(opts) opts->x_target_flags |= MASK_LLSC
/* LONG64 mask */
#define TARGET_LONG64 ((target_flags & MASK_LONG64) != 0)
#define TARGET_LONG64_P(target_flags) (((target_flags) & MASK_LONG64) != 0)
#define TARGET_EXPLICIT_LONG64_P(opts) ((opts->x_target_flags_explicit & MASK_LONG64) != 0)
#define SET_TARGET_LONG64(opts) opts->x_target_flags |= MASK_LONG64
/* LOONGSON_EXT mask */
#define TARGET_LOONGSON_EXT ((target_flags & MASK_LOONGSON_EXT) != 0)
#define TARGET_LOONGSON_EXT_P(target_flags) (((target_flags) & MASK_LOONGSON_EXT) != 0)
#define TARGET_EXPLICIT_LOONGSON_EXT_P(opts) ((opts->x_target_flags_explicit & MASK_LOONGSON_EXT) != 0)
#define SET_TARGET_LOONGSON_EXT(opts) opts->x_target_flags |= MASK_LOONGSON_EXT
/* LOONGSON_MMI mask */
#define TARGET_LOONGSON_MMI ((target_flags & MASK_LOONGSON_MMI) != 0)
#define TARGET_LOONGSON_MMI_P(target_flags) (((target_flags) & MASK_LOONGSON_MMI) != 0)
#define TARGET_EXPLICIT_LOONGSON_MMI_P(opts) ((opts->x_target_flags_explicit & MASK_LOONGSON_MMI) != 0)
#define SET_TARGET_LOONGSON_MMI(opts) opts->x_target_flags |= MASK_LOONGSON_MMI
/* MEMCPY mask */
#define TARGET_MEMCPY ((target_flags & MASK_MEMCPY) != 0)
#define TARGET_MEMCPY_P(target_flags) (((target_flags) & MASK_MEMCPY) != 0)
#define TARGET_EXPLICIT_MEMCPY_P(opts) ((opts->x_target_flags_explicit & MASK_MEMCPY) != 0)
#define SET_TARGET_MEMCPY(opts) opts->x_target_flags |= MASK_MEMCPY
/* MICROMIPS mask */
...
#define TARGET_EXPLICIT_MICROMIPS_P(opts) ((opts->x_target_flags_explicit & MASK_MICROMIPS) != 0)
#define SET_TARGET_MICROMIPS(opts) opts->x_target_flags |= MASK_MICROMIPS
/* MSA mask */
#define TARGET_MSA ((target_flags & MASK_MSA) != 0)
#define TARGET_MSA_P(target_flags) (((target_flags) & MASK_MSA) != 0)
#define TARGET_EXPLICIT_MSA_P(opts) ((opts->x_target_flags_explicit & MASK_MSA) != 0)
#define SET_TARGET_MSA(opts) opts->x_target_flags |= MASK_MSA
/* ODD_SPREG mask */
...
#define TARGET_EXPLICIT_ODD_SPREG_P(opts) ((opts->x_target_flags_explicit & MASK_ODD_SPREG) != 0)
#define SET_TARGET_ODD_SPREG(opts) opts->x_target_flags |= MASK_ODD_SPREG
/* PAIRED_SINGLE_FLOAT mask */
...
#define TARGET_EXPLICIT_PAIRED_SINGLE_FLOAT_P(opts) ((opts->x_target_flags_explicit & MASK_PAIRED_SINGLE_FLOAT) != 0)
#define SET_TARGET_PAIRED_SINGLE_FLOAT(opts) opts->x_target_flags |= MASK_PAIRED_SINGLE_FLOAT
/* RELAX_PIC_CALLS mask */
...
#define TARGET_EXPLICIT_RELAX_PIC_CALLS_P(opts) ((opts->x_target_flags_explicit & MASK_RELAX_PIC_CALLS) != 0)
#define SET_TARGET_RELAX_PIC_CALLS(opts) opts->x_target_flags |= MASK_RELAX_PIC_CALLS
/* SMARTMIPS mask */
...
#define TARGET_EXPLICIT_SMARTMIPS_P(opts) ((opts->x_target_flags_explicit & MASK_SMARTMIPS) != 0)
#define SET_TARGET_SMARTMIPS(opts) opts->x_target_flags |= MASK_SMARTMIPS
/* SPLIT_ADDRESSES mask */
...
#define TARGET_EXPLICIT_SPLIT_ADDRESSES_P(opts) ((opts->x_target_flags_explicit & MASK_SPLIT_ADDRESSES) != 0)
#define SET_TARGET_SPLIT_ADDRESSES(opts) opts->x_target_flags |= MASK_SPLIT_ADDRESSES
/* SYNCI mask */
#define TARGET_SYNCI ((target_flags & MASK_SYNCI) != 0)
#define TARGET_SYNCI_P(target_flags) (((target_flags) & MASK_SYNCI) != 0)
#define TARGET_EXPLICIT_SYNCI_P(opts) ((opts->x_target_flags_explicit & MASK_SYNCI) != 0)
#define SET_TARGET_SYNCI(opts) opts->x_target_flags |= MASK_SYNCI
/* VR4130_ALIGN mask */
...
#define TARGET_EXPLICIT_VR4130_ALIGN_P(opts) ((opts->x_target_flags_explicit & MASK_VR4130_ALIGN) != 0)
#define SET_TARGET_VR4130_ALIGN(opts) opts->x_target_flags |= MASK_VR4130_ALIGN
...
enum opt_code
{
  ...
  OPT_list = 1766,                           /* -list */
  OPT_mabi_ = 1767,                          /* -mabi= */
  OPT_mabicalls = 1768,                      /* -mabicalls */
  OPT_mabs_ = 1769,                          /* -mabs= */
  OPT_march_ = 1770,                         /* -march= */
  OPT_mbranch_cost_ = 1771,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1772,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1773,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1774,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1775,             /* -mcompact-branches= */
  OPT_mcrc = 1776,                           /* -mcrc */
  OPT_mdebug = 1777,                         /* -mdebug */
  OPT_mdebugd = 1778,                        /* -mdebugd */
  OPT_mdivide_breaks = 1779,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1780,                  /* -mdivide-traps */
  OPT_mdmx = 1781,                           /* -mdmx */
  OPT_mdouble_float = 1782,                  /* -mdouble-float */
  OPT_mdsp = 1783,                           /* -mdsp */
  OPT_mdspr2 = 1784,                         /* -mdspr2 */
  OPT_meb = 1785,                            /* -meb */
  OPT_mel = 1786,                            /* -mel */
  OPT_membedded_data = 1787,                 /* -membedded-data */
  OPT_meva = 1788,                           /* -meva */
  OPT_mexplicit_relocs = 1789,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1790,                  /* -mextern-sdata */
  OPT_mfix_24k = 1791,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1792,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1793,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1794,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1795,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1796,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1797,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1798,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1799,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1800,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1801,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1802,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1803,                 /* -mfp-exceptions */
  OPT_mfp32 = 1804,                          /* -mfp32 */
  OPT_mfp64 = 1805,                          /* -mfp64 */
  OPT_mfpxx = 1806,                          /* -mfpxx */
  OPT_mframe_header_opt = 1807,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1808, */              /* -mfused-madd */
  OPT_mginv = 1809,                          /* -mginv */
  OPT_mgp32 = 1810,                          /* -mgp32 */
  OPT_mgp64 = 1811,                          /* -mgp64 */
  OPT_mgpopt = 1812,                         /* -mgpopt */
  OPT_mhard_float = 1813,                    /* -mhard-float */
  OPT_mimadd = 1814,                         /* -mimadd */
  OPT_minterlink_compressed = 1815,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1816,              /* -minterlink-mips16 */
  OPT_mips = 1817,                           /* -mips */
  OPT_mips16 = 1818,                         /* -mips16 */
  OPT_mips3d = 1819,                         /* -mips3d */
  OPT_mllsc = 1820,                          /* -mllsc */
  OPT_mload_store_pairs = 1821,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1822,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1823,                    /* -mlong-calls */
  OPT_mlong32 = 1824,                        /* -mlong32 */
  OPT_mlong64 = 1825,                        /* -mlong64 */
  OPT_mloongson_ext = 1826,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1827,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1828,                  /* -mloongson-mmi */
  OPT_mlra = 1829,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1830,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1831,                           /* -mmad */
  OPT_mmadd4 = 1832,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1833,             /* -mmcount-ra-address */
  OPT_mmcu = 1834,                           /* -mmcu */
  OPT_mmemcpy = 1835,                        /* -mmemcpy */
  OPT_mmicromips = 1836,                     /* -mmicromips */
  OPT_mmsa = 1837,                           /* -mmsa */
  OPT_mmt = 1838,                            /* -mmt */
  OPT_mnan_ = 1839,                          /* -mnan= */
  OPT_mno_float = 1840,                      /* -mno-float */
  OPT_mno_flush_func = 1841,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1842,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1843,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1844,                     /* -mno-mips3d */
  OPT_modd_spreg = 1845,                     /* -modd-spreg */
  OPT_mpaired_single = 1846,                 /* -mpaired-single */
  OPT_mplt = 1847,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1848,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1849,               /* -mrelax-pic-calls */
  OPT_mshared = 1850,                        /* -mshared */
  OPT_msingle_float = 1851,                  /* -msingle-float */
  OPT_msmartmips = 1852,                     /* -msmartmips */
  OPT_msoft_float = 1853,                    /* -msoft-float */
  OPT_msplit_addresses = 1854,               /* -msplit-addresses */
  OPT_msym32 = 1855,                         /* -msym32 */
  OPT_msynci = 1856,                         /* -msynci */
  OPT_mtune_ = 1857,                         /* -mtune= */
  OPT_munaligned_access = 1858,              /* -munaligned-access */
  OPT_muninit_const_in_rodata = 1859,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1860,                          /* -mvirt */
  OPT_mvr4130_align = 1861,                  /* -mvr4130-align */
  OPT_mxgot = 1862,                          /* -mxgot */
  OPT_mxpa = 1863,                           /* -mxpa */
  OPT_n = 1864,                              /* -n */
  OPT_name_sort = 1865,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1866,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1867,              /* -no-integrated-cpp */
  OPT_no_pie = 1868,                         /* -no-pie */
  OPT_noasmopt = 1869,                       /* -noasmopt */
  OPT_nocpp = 1870,                          /* -nocpp */
  OPT_nodefaultlibs = 1871,                  /* -nodefaultlibs */
  OPT_nolibc = 1872,                         /* -nolibc */
  OPT_nophoboslib = 1873,                    /* -nophoboslib */
  OPT_nostartfiles = 1874,                   /* -nostartfiles */
  OPT_nostdinc = 1875,                       /* -nostdinc */
  OPT_nostdinc__ = 1876,                     /* -nostdinc++ */
  OPT_nostdlib = 1877,                       /* -nostdlib */
  OPT_o = 1878,                              /* -o */
  OPT_objects = 1879,                        /* -objects */
  OPT_p = 1880,                              /* -p */
  OPT_pass_exit_codes = 1881,                /* -pass-exit-codes */
  /* OPT_pedantic = 1882, */                 /* -pedantic */
  OPT_pedantic_errors = 1883,                /* -pedantic-errors */
  OPT_pg = 1884,                             /* -pg */
  OPT_pie = 1885,                            /* -pie */
  OPT_pipe = 1886,                           /* -pipe */
  OPT_print_file_name_ = 1887,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1888,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1889,          /* -print-multi-directory */
  OPT_print_multi_lib = 1890,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1891,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1892,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1893,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1894,               /* -print-prog-name= */
  OPT_print_search_dirs = 1895,              /* -print-search-dirs */
  OPT_print_sysroot = 1896,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1897,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1898,                    /* -print-value */
  OPT_quiet = 1899,                          /* -quiet */
  OPT_r = 1900,                              /* -r */
  OPT_remap = 1901,                          /* -remap */
  OPT_reverse_sort = 1902,                   /* -reverse-sort */
  OPT_s = 1903,                              /* -s */
  OPT_save_temps = 1904,                     /* -save-temps */
  OPT_save_temps_ = 1905,                    /* -save-temps= */
  OPT_shared = 1906,                         /* -shared */
  OPT_shared_libgcc = 1907,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1908,               /* -shared-libphobos */
  OPT_size_sort = 1909,                      /* -size-sort */
  /* OPT_specs = 1910, */                    /* -specs */
  OPT_specs_ = 1911,                         /* -specs= */
  OPT_static = 1912,                         /* -static */
  OPT_static_libasan = 1913,                 /* -static-libasan */
  OPT_static_libgcc = 1914,                  /* -static-libgcc */
  OPT_static_libgfortran = 1915,             /* -static-libgfortran */
  OPT_static_libgo = 1916,                   /* -static-libgo */
  OPT_static_libhwasan = 1917,               /* -static-libhwasan */
  OPT_static_liblsan = 1918,                 /* -static-liblsan */
  OPT_static_libmpx = 1919,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1920,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1921,               /* -static-libphobos */
  OPT_static_libstdc__ = 1922,               /* -static-libstdc++ */
  OPT_static_libtsan = 1923,                 /* -static-libtsan */
  OPT_static_libubsan = 1924,                /* -static-libubsan */
  OPT_static_pie = 1925,                     /* -static-pie */
  /* OPT_std_c__03 = 1926, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1927, */                /* -std=c++0x */
  OPT_std_c__11 = 1928,                      /* -std=c++11 */
  OPT_std_c__14 = 1929,                      /* -std=c++14 */
  OPT_std_c__17 = 1930,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1931, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1932, */                /* -std=c++1z */
  OPT_std_c__20 = 1933,                      /* -std=c++20 */
  OPT_std_c__23 = 1934,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1935, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1936, */                /* -std=c++2b */
  OPT_std_c__98 = 1937,                      /* -std=c++98 */
  OPT_std_c11 = 1938,                        /* -std=c11 */
  OPT_std_c17 = 1939,                        /* -std=c17 */
  /* OPT_std_c18 = 1940, */                  /* -std=c18 */
  /* OPT_std_c1x = 1941, */                  /* -std=c1x */
  OPT_std_c2x = 1942,                        /* -std=c2x */
  /* OPT_std_c89 = 1943, */                  /* -std=c89 */
  OPT_std_c90 = 1944,                        /* -std=c90 */
  OPT_std_c99 = 1945,                        /* -std=c99 */
  /* OPT_std_c9x = 1946, */                  /* -std=c9x */
  OPT_std_f2003 = 1947,                      /* -std=f2003 */
  OPT_std_f2008 = 1948,                      /* -std=f2008 */
  OPT_std_f2008ts = 1949,                    /* -std=f2008ts */
  OPT_std_f2018 = 1950,                      /* -std=f2018 */
  OPT_std_f95 = 1951,                        /* -std=f95 */
  OPT_std_gnu = 1952,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1953, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1954, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1955,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1956,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1957,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1958, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1959, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1960,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1961,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1962, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1963, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1964,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1965,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1966,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1967, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1968, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1969,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1970, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1971,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1972,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1973, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1974, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1975,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1976, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1977, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1978, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1979, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1980, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1981,                     /* -std=legacy */
  OPT_stdlib_ = 1982,                        /* -stdlib= */
  OPT_symbol_ = 1983,                        /* -symbol= */
  OPT_symbolic = 1984,                       /* -symbolic */
  OPT_t = 1985,                              /* -t */
  OPT_time = 1986,                           /* -time */
  OPT_time_ = 1987,                          /* -time= */
  OPT_traditional = 1988,                    /* -traditional */
  OPT_traditional_cpp = 1989,                /* -traditional-cpp */
  OPT_tree_stats = 1990,                     /* -tree-stats */
  OPT_trigraphs = 1991,                      /* -trigraphs */
  OPT_type_stats = 1992,                     /* -type-stats */
  OPT_u = 1993,                              /* -u */
  OPT_undef = 1994,                          /* -undef */
  OPT_v = 1995,                              /* -v */
  OPT_version = 1996,                        /* -version */
  OPT_w = 1997,                              /* -w */
  OPT_wrapper = 1998,                        /* -wrapper */
  OPT_x = 1999,                              /* -x */
  OPT_z = 2000,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
