...
#define HAVE_movmisalignhi (ISA_HAS_UNALIGNED_ACCESS)
#define HAVE_movmisalignsi (ISA_HAS_UNALIGNED_ACCESS)
#define HAVE_movmisalignsf ((ISA_HAS_UNALIGNED_ACCESS) && (TARGET_HARD_FLOAT))
#define HAVE_movmisaligndf ((ISA_HAS_UNALIGNED_ACCESS) && (TARGET_HARD_FLOAT \
				      && TARGET_DOUBLE_FLOAT))
...
#define HAVE_vcondv16qiv16qi (ISA_HAS_MSA \
   && (GET_MODE_NUNITS (V16QImode) == GET_MODE_NUNITS (V16QImode)))
#define HAVE_vec_cmpv2dfv2di (ISA_HAS_MSA)
#define HAVE_vec_cmpv4sfv4si (ISA_HAS_MSA)
#define HAVE_vec_cmpv2div2di (ISA_HAS_MSA)
#define HAVE_vec_cmpv4siv4si (ISA_HAS_MSA)
#define HAVE_vec_cmpv8hiv8hi (ISA_HAS_MSA)
#define HAVE_vec_cmpv16qiv16qi (ISA_HAS_MSA)
#define HAVE_vec_cmpuv2div2di (ISA_HAS_MSA)
#define HAVE_vec_cmpuv4siv4si (ISA_HAS_MSA)
#define HAVE_vec_cmpuv8hiv8hi (ISA_HAS_MSA)
#define HAVE_vec_cmpuv16qiv16qi (ISA_HAS_MSA)
...
static inline rtx gen_tls_get_tp_mips16_si            (rtx, rtx);
static inline rtx
gen_tls_get_tp_mips16_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_tls_get_tp_mips16_di            (rtx, rtx);
static inline rtx
gen_tls_get_tp_mips16_di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
extern rtx        gen_movmisaligndf                   (rtx, rtx);
...
static inline rtx gen_get_thread_pointerdi            (rtx);
static inline rtx
gen_get_thread_pointerdi(rtx ARG_UNUSED (a))
{
  return 0;
}
