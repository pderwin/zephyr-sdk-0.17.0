...
enum insn_code {
  ...
  CODE_FOR_sync_lock_releasesi = 75,
   CODE_FOR_sync_compare_and_swapsi = CODE_FOR_nothing,
  CODE_FOR_mulsidi3 = 76,
  CODE_FOR_umulsidi3 = 77,
  CODE_FOR_ctzsi2 = 78,
  CODE_FOR_ffssi2 = 79,
  CODE_FOR_one_cmplsi2 = 80,
  CODE_FOR_extendhisi2 = 81,
  CODE_FOR_extendqisi2 = 82,
  CODE_FOR_extv = 83,
  CODE_FOR_extzv = 84,
  CODE_FOR_movdi = 85,
  CODE_FOR_movsi = 86,
  CODE_FOR_movhi = 87,
  CODE_FOR_movqi = 88,
  CODE_FOR_reloadhi_literal = 89,
  CODE_FOR_reloadqi_literal = 90,
  CODE_FOR_movsf = 91,
  CODE_FOR_movdf = 92,
  CODE_FOR_cpymemsi = 93,
  CODE_FOR_ashlsi3 = 94,
  CODE_FOR_cbranchsi4 = 95,
  ...
  CODE_FOR_movsicc = 97,
  CODE_FOR_movsfcc = 98,
  CODE_FOR_indirect_jump = 99,
  CODE_FOR_tablejump = 100,
  CODE_FOR_sym_PLT = 101,
  CODE_FOR_call = 102,
  CODE_FOR_call_value = 103,
  CODE_FOR_allocate_stack = 104,
  CODE_FOR_prologue = 105,
  CODE_FOR_epilogue = 106,
  CODE_FOR_nonlocal_goto = 107,
  CODE_FOR_eh_return = 108,
  CODE_FOR_frame_blockage = 109,
  CODE_FOR_sym_TPOFF = 110,
  CODE_FOR_sym_DTPOFF = 111,
  CODE_FOR_memory_barrier = 112,
...
const unsigned int NUM_INSN_CODES = 113;
