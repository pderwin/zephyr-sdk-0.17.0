...
#define HAVE_ATTR_cost 1
extern int get_attr_cost (rtx_insn *);
#define HAVE_ATTR_type 1
extern enum attr_type get_attr_type (rtx_insn *);

#define HAVE_ATTR_iscompact 1
extern enum attr_iscompact get_attr_iscompact (rtx_insn *);
...
#define HAVE_ATTR_cpu_facility 1
extern enum attr_cpu_facility get_attr_cpu_facility (rtx_insn *);

#define HAVE_ATTR_enabled 1
extern enum attr_enabled get_attr_enabled (rtx_insn *);

#define HAVE_ATTR_slottable 1
extern enum attr_slottable get_attr_slottable (rtx_insn *);

#define HAVE_ATTR_call_slottable 1
extern enum attr_call_slottable get_attr_call_slottable (rtx_insn *);

#define HAVE_ATTR_delay_slot_filled 1
extern enum attr_delay_slot_filled get_attr_delay_slot_filled (rtx_insn *);

#define HAVE_ATTR_delay_slot_length 1
extern int get_attr_delay_slot_length (rtx_insn *);
