/* Generated automatically from machmode.def and config/arc64/arc64-modes.def
   by genmodes.  */
...
#endif
  E_CC_ZNmode,             /* config/arc64/arc64-modes.def:20 */
...
#endif
  E_CC_Zmode,              /* config/arc64/arc64-modes.def:21 */
...
#endif
  E_CC_Cmode,              /* config/arc64/arc64-modes.def:22 */
...
#endif
  E_CC_Vmode,              /* config/arc64/arc64-modes.def:23 */
...
#endif
  E_CC_FPUmode,            /* config/arc64/arc64-modes.def:24 */
...
#endif
  E_CC_FPUEmode,           /* config/arc64/arc64-modes.def:25 */
...
#endif
  E_HFmode,                /* config/arc64/arc64-modes.def:28 */
#define HAVE_HFmode
#ifdef USE_ENUM_MODES
...
#endif
  E_V4QImode,              /* config/arc64/arc64-modes.def:32 */
...
#endif
  E_V2HImode,              /* config/arc64/arc64-modes.def:32 */
...
#endif
  E_V8QImode,              /* config/arc64/arc64-modes.def:33 */
...
#endif
  E_V4HImode,              /* config/arc64/arc64-modes.def:33 */
...
#endif
  E_V2SImode,              /* config/arc64/arc64-modes.def:33 */
...
#endif
  E_V2HFmode,              /* config/arc64/arc64-modes.def:36 */
...
#endif
  E_V4HFmode,              /* config/arc64/arc64-modes.def:37 */
...
#endif
  E_V2SFmode,              /* config/arc64/arc64-modes.def:37 */
...
#endif
  E_V8HFmode,              /* config/arc64/arc64-modes.def:38 */
...
#endif
  E_V4SFmode,              /* config/arc64/arc64-modes.def:38 */
...
#endif
  E_V2DFmode,              /* config/arc64/arc64-modes.def:38 */
