...
#include "config/arc64/arc64-opts.h"
...
extern bool arc64_target_64bit;
#else
  bool x_arc64_target_64bit;
#define arc64_target_64bit global_options.x_arc64_target_64bit
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int arc64_atomic_option;
#else
  int x_arc64_atomic_option;
#define arc64_atomic_option global_options.x_arc64_atomic_option
#endif
#ifdef GENERATOR_FILE
extern enum arc64_code_model arc64_cmodel_var;
#else
  enum arc64_code_model x_arc64_cmodel_var;
#define arc64_cmodel_var global_options.x_arc64_cmodel_var
#endif
#ifdef GENERATOR_FILE
extern const char *arcv3_cpu_string;
#else
  const char *x_arcv3_cpu_string;
#define arcv3_cpu_string global_options.x_arcv3_cpu_string
#endif
#ifdef GENERATOR_FILE
extern int TARGET_ARC64_DIVREM;
#else
  int x_TARGET_ARC64_DIVREM;
#define TARGET_ARC64_DIVREM global_options.x_TARGET_ARC64_DIVREM
#endif
#ifdef GENERATOR_FILE
extern int arc64_fp_model;
#else
  int x_arc64_fp_model;
#define arc64_fp_model global_options.x_arc64_fp_model
#endif
#ifdef GENERATOR_FILE
...
#define MASK_WIDE_LDST (1U << 0)
#define MASK_BBIT (1U << 1)
#define MASK_BITSCAN (1U << 2)
#define MASK_BRCC (1U << 3)
#define MASK_CODE_DENSITY (1U << 4)
#define MASK_EXP (1U << 5)
#define MASK_FP_MOVE (1U << 6)
#define MASK_LL64 (1U << 7)
#define MASK_SIMD (1U << 8)
#define MASK_VOLATILE_DI (1U << 9)
#define MASK_WIDE_SIMD (1U << 10)

/* WIDE_LDST mask */
#define TARGET_WIDE_LDST ((target_flags & MASK_WIDE_LDST) != 0)
#define TARGET_WIDE_LDST_P(target_flags) (((target_flags) & MASK_WIDE_LDST) != 0)
#define TARGET_EXPLICIT_WIDE_LDST_P(opts) ((opts->x_target_flags_explicit & MASK_WIDE_LDST) != 0)
#define SET_TARGET_WIDE_LDST(opts) opts->x_target_flags |= MASK_WIDE_LDST
/* BBIT mask */
#define TARGET_BBIT ((target_flags & MASK_BBIT) != 0)
#define TARGET_BBIT_P(target_flags) (((target_flags) & MASK_BBIT) != 0)
#define TARGET_EXPLICIT_BBIT_P(opts) ((opts->x_target_flags_explicit & MASK_BBIT) != 0)
#define SET_TARGET_BBIT(opts) opts->x_target_flags |= MASK_BBIT
/* BITSCAN mask */
#define TARGET_BITSCAN ((target_flags & MASK_BITSCAN) != 0)
#define TARGET_BITSCAN_P(target_flags) (((target_flags) & MASK_BITSCAN) != 0)
#define TARGET_EXPLICIT_BITSCAN_P(opts) ((opts->x_target_flags_explicit & MASK_BITSCAN) != 0)
#define SET_TARGET_BITSCAN(opts) opts->x_target_flags |= MASK_BITSCAN
/* BRCC mask */
#define TARGET_BRCC ((target_flags & MASK_BRCC) != 0)
#define TARGET_BRCC_P(target_flags) (((target_flags) & MASK_BRCC) != 0)
#define TARGET_EXPLICIT_BRCC_P(opts) ((opts->x_target_flags_explicit & MASK_BRCC) != 0)
#define SET_TARGET_BRCC(opts) opts->x_target_flags |= MASK_BRCC
/* CODE_DENSITY mask */
...
/* EXP mask */
#define TARGET_EXP ((target_flags & MASK_EXP) != 0)
#define TARGET_EXP_P(target_flags) (((target_flags) & MASK_EXP) != 0)
#define TARGET_EXPLICIT_EXP_P(opts) ((opts->x_target_flags_explicit & MASK_EXP) != 0)
#define SET_TARGET_EXP(opts) opts->x_target_flags |= MASK_EXP
/* FP_MOVE mask */
#define TARGET_FP_MOVE ((target_flags & MASK_FP_MOVE) != 0)
#define TARGET_FP_MOVE_P(target_flags) (((target_flags) & MASK_FP_MOVE) != 0)
#define TARGET_EXPLICIT_FP_MOVE_P(opts) ((opts->x_target_flags_explicit & MASK_FP_MOVE) != 0)
#define SET_TARGET_FP_MOVE(opts) opts->x_target_flags |= MASK_FP_MOVE
/* LL64 mask */
...
#define TARGET_EXPLICIT_SIMD_P(opts) ((opts->x_target_flags_explicit & MASK_SIMD) != 0)
#define SET_TARGET_SIMD(opts) opts->x_target_flags |= MASK_SIMD
/* VOLATILE_DI mask */
#define TARGET_VOLATILE_DI ((target_flags & MASK_VOLATILE_DI) != 0)
#define TARGET_VOLATILE_DI_P(target_flags) (((target_flags) & MASK_VOLATILE_DI) != 0)
#define TARGET_EXPLICIT_VOLATILE_DI_P(opts) ((opts->x_target_flags_explicit & MASK_VOLATILE_DI) != 0)
#define SET_TARGET_VOLATILE_DI(opts) opts->x_target_flags |= MASK_VOLATILE_DI
/* WIDE_SIMD mask */
#define TARGET_WIDE_SIMD ((target_flags & MASK_WIDE_SIMD) != 0)
#define TARGET_WIDE_SIMD_P(target_flags) (((target_flags) & MASK_WIDE_SIMD) != 0)
#define TARGET_EXPLICIT_WIDE_SIMD_P(opts) ((opts->x_target_flags_explicit & MASK_WIDE_SIMD) != 0)
#define SET_TARGET_WIDE_SIMD(opts) opts->x_target_flags |= MASK_WIDE_SIMD
...
enum opt_code
{
  ...
  OPT_list = 1763,                           /* -list */
  OPT_m128 = 1764,                           /* -m128 */
  OPT_matomic_ = 1765,                       /* -matomic= */
  OPT_mbbit = 1766,                          /* -mbbit */
  OPT_mbitscan = 1767,                       /* -mbitscan */
  OPT_mbrcc = 1768,                          /* -mbrcc */
  OPT_mcmodel_ = 1769,                       /* -mcmodel= */
  OPT_mcode_density = 1770,                  /* -mcode-density */
  OPT_mcpu_ = 1771,                          /* -mcpu= */
  OPT_mdiv_rem = 1772,                       /* -mdiv-rem */
  OPT_mexperimental = 1773,                  /* -mexperimental */
  OPT_mfpmov = 1774,                         /* -mfpmov */
  OPT_mfpu_ = 1775,                          /* -mfpu= */
  OPT_mll64 = 1776,                          /* -mll64 */
  OPT_msimd = 1777,                          /* -msimd */
  OPT_munaligned_access = 1778,              /* -munaligned-access */
  OPT_mvolatile_di = 1779,                   /* -mvolatile-di */
  OPT_mwide = 1780,                          /* -mwide */
  OPT_n = 1781,                              /* -n */
  OPT_name_sort = 1782,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1783,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1784,              /* -no-integrated-cpp */
  OPT_no_pie = 1785,                         /* -no-pie */
  OPT_nocpp = 1786,                          /* -nocpp */
  OPT_nodefaultlibs = 1787,                  /* -nodefaultlibs */
  OPT_nolibc = 1788,                         /* -nolibc */
  OPT_nophoboslib = 1789,                    /* -nophoboslib */
  OPT_nostartfiles = 1790,                   /* -nostartfiles */
  OPT_nostdinc = 1791,                       /* -nostdinc */
  OPT_nostdinc__ = 1792,                     /* -nostdinc++ */
  OPT_nostdlib = 1793,                       /* -nostdlib */
  OPT_o = 1794,                              /* -o */
  OPT_objects = 1795,                        /* -objects */
  OPT_p = 1796,                              /* -p */
  OPT_pass_exit_codes = 1797,                /* -pass-exit-codes */
  /* OPT_pedantic = 1798, */                 /* -pedantic */
  OPT_pedantic_errors = 1799,                /* -pedantic-errors */
  OPT_pg = 1800,                             /* -pg */
  OPT_pie = 1801,                            /* -pie */
  OPT_pipe = 1802,                           /* -pipe */
  OPT_print_file_name_ = 1803,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1804,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1805,          /* -print-multi-directory */
  OPT_print_multi_lib = 1806,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1807,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1808,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1809,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1810,               /* -print-prog-name= */
  OPT_print_search_dirs = 1811,              /* -print-search-dirs */
  OPT_print_sysroot = 1812,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1813,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1814,                    /* -print-value */
  OPT_quiet = 1815,                          /* -quiet */
  OPT_r = 1816,                              /* -r */
  OPT_remap = 1817,                          /* -remap */
  OPT_reverse_sort = 1818,                   /* -reverse-sort */
  OPT_s = 1819,                              /* -s */
  OPT_save_temps = 1820,                     /* -save-temps */
  OPT_save_temps_ = 1821,                    /* -save-temps= */
  OPT_shared = 1822,                         /* -shared */
  OPT_shared_libgcc = 1823,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1824,               /* -shared-libphobos */
  OPT_size_sort = 1825,                      /* -size-sort */
  /* OPT_specs = 1826, */                    /* -specs */
  OPT_specs_ = 1827,                         /* -specs= */
  OPT_static = 1828,                         /* -static */
  OPT_static_libasan = 1829,                 /* -static-libasan */
  OPT_static_libgcc = 1830,                  /* -static-libgcc */
  OPT_static_libgfortran = 1831,             /* -static-libgfortran */
  OPT_static_libgo = 1832,                   /* -static-libgo */
  OPT_static_libhwasan = 1833,               /* -static-libhwasan */
  OPT_static_liblsan = 1834,                 /* -static-liblsan */
  OPT_static_libmpx = 1835,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1836,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1837,               /* -static-libphobos */
  OPT_static_libstdc__ = 1838,               /* -static-libstdc++ */
  OPT_static_libtsan = 1839,                 /* -static-libtsan */
  OPT_static_libubsan = 1840,                /* -static-libubsan */
  OPT_static_pie = 1841,                     /* -static-pie */
  /* OPT_std_c__03 = 1842, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1843, */                /* -std=c++0x */
  OPT_std_c__11 = 1844,                      /* -std=c++11 */
  OPT_std_c__14 = 1845,                      /* -std=c++14 */
  OPT_std_c__17 = 1846,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1847, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1848, */                /* -std=c++1z */
  OPT_std_c__20 = 1849,                      /* -std=c++20 */
  OPT_std_c__23 = 1850,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1851, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1852, */                /* -std=c++2b */
  OPT_std_c__98 = 1853,                      /* -std=c++98 */
  OPT_std_c11 = 1854,                        /* -std=c11 */
  OPT_std_c17 = 1855,                        /* -std=c17 */
  /* OPT_std_c18 = 1856, */                  /* -std=c18 */
  /* OPT_std_c1x = 1857, */                  /* -std=c1x */
  OPT_std_c2x = 1858,                        /* -std=c2x */
  /* OPT_std_c89 = 1859, */                  /* -std=c89 */
  OPT_std_c90 = 1860,                        /* -std=c90 */
  OPT_std_c99 = 1861,                        /* -std=c99 */
  /* OPT_std_c9x = 1862, */                  /* -std=c9x */
  OPT_std_f2003 = 1863,                      /* -std=f2003 */
  OPT_std_f2008 = 1864,                      /* -std=f2008 */
  OPT_std_f2008ts = 1865,                    /* -std=f2008ts */
  OPT_std_f2018 = 1866,                      /* -std=f2018 */
  OPT_std_f95 = 1867,                        /* -std=f95 */
  OPT_std_gnu = 1868,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1869, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1870, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1871,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1872,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1873,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1874, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1875, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1876,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1877,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1878, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1879, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1880,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1881,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1882,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1883, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1884, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1885,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1886, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1887,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1888,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1889, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1890, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1891,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1892, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1893, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1894, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1895, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1896, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1897,                     /* -std=legacy */
  OPT_stdlib_ = 1898,                        /* -stdlib= */
  OPT_symbol_ = 1899,                        /* -symbol= */
  OPT_symbolic = 1900,                       /* -symbolic */
  OPT_t = 1901,                              /* -t */
  OPT_time = 1902,                           /* -time */
  OPT_time_ = 1903,                          /* -time= */
  OPT_traditional = 1904,                    /* -traditional */
  OPT_traditional_cpp = 1905,                /* -traditional-cpp */
  OPT_tree_stats = 1906,                     /* -tree-stats */
  OPT_trigraphs = 1907,                      /* -trigraphs */
  OPT_type_stats = 1908,                     /* -type-stats */
  OPT_u = 1909,                              /* -u */
  OPT_undef = 1910,                          /* -undef */
  OPT_v = 1911,                              /* -v */
  OPT_version = 1912,                        /* -version */
  OPT_w = 1913,                              /* -w */
  OPT_wrapper = 1914,                        /* -wrapper */
  OPT_x = 1915,                              /* -x */
  OPT_z = 1916,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
