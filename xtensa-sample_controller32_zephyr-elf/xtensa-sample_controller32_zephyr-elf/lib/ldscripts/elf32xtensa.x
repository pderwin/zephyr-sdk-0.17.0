...
ENTRY(_start)
SEARCH_DIR("=/__w/_temp/workspace/output/xtensa-sample_controller32_zephyr-elf/xtensa-sample_controller32_zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
