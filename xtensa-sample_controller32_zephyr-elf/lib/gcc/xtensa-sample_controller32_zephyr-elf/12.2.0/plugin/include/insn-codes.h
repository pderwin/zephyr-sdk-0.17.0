...
enum insn_code {
  ...
  CODE_FOR_extendhisi2 = 75,
  CODE_FOR_extendqisi2 = 76,
  CODE_FOR_extv = 77,
  CODE_FOR_extzv = 78,
  CODE_FOR_movdi = 79,
  CODE_FOR_movsi = 80,
  CODE_FOR_movhi = 81,
  CODE_FOR_movqi = 82,
  CODE_FOR_reloadhi_literal = 83,
  CODE_FOR_reloadqi_literal = 84,
  CODE_FOR_movsf = 85,
  CODE_FOR_movdf = 86,
  CODE_FOR_cpymemsi = 87,
  CODE_FOR_ashlsi3 = 88,
  CODE_FOR_cbranchsi4 = 89,
   CODE_FOR_cbranchsf4 = CODE_FOR_nothing,
   CODE_FOR_doloop_end = CODE_FOR_nothing,
  CODE_FOR_cstoresi4 = 90,
  ...
  CODE_FOR_sym_PLT = 95,
  CODE_FOR_call = 96,
  CODE_FOR_call_value = 97,
  CODE_FOR_allocate_stack = 98,
  CODE_FOR_prologue = 99,
  CODE_FOR_epilogue = 100,
  CODE_FOR_nonlocal_goto = 101,
  CODE_FOR_eh_return = 102,
  CODE_FOR_frame_blockage = 103,
  CODE_FOR_sym_TPOFF = 104,
  CODE_FOR_sym_DTPOFF = 105,
  CODE_FOR_memory_barrier = 106,
...
const unsigned int NUM_INSN_CODES = 107;
