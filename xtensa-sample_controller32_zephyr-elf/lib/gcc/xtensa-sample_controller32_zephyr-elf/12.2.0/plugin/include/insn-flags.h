...
static inline rtx gen_zero_cost_loop_start     (rtx, rtx, rtx);
static inline rtx
gen_zero_cost_loop_start(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_zero_cost_loop_end       (rtx, rtx, rtx);
static inline rtx
gen_zero_cost_loop_end(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_loop_end                 (rtx, rtx, rtx);
static inline rtx
gen_loop_end(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_doloop_end               (rtx, rtx);
static inline rtx
gen_doloop_end(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
