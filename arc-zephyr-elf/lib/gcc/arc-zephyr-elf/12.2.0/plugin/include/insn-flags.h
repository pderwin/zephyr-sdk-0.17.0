...
#define HAVE_casesi_dispatch (TARGET_BI_BIH)
#define HAVE_casesi_load 1
#define HAVE_casesi_jump 1
#define HAVE_trap (!TARGET_ARC600_FAMILY)
#define HAVE_nop 1
#define HAVE_nopv 1
#define HAVE_blockage 1
#define HAVE_arc600_stall (TARGET_MUL64_SET)
...
#define HAVE_lr 1
#define HAVE_sr 1
#define HAVE_lddiqi 1
#define HAVE_lddihi 1
#define HAVE_lddisi 1
#define HAVE_lddidi (TARGET_LL64)
#define HAVE_stdiqi 1
#define HAVE_stdihi 1
#define HAVE_stdisi 1
#define HAVE_stdidi (TARGET_LL64)
#define HAVE_trap_s (!TARGET_ARC600_FAMILY)
#define HAVE_unimp_s (!TARGET_ARC600_FAMILY)
#define HAVE_simple_return 1
#define HAVE_arc600_rtie (TARGET_ARC600_FAMILY)
...
#define HAVE_arc_lp 1
#define HAVE_loop_end 1
#define HAVE_loop_fail 1
#define HAVE_dbnz (TARGET_DBNZ)
...
#define HAVE_machi (TARGET_PLUS_MACD)
#define HAVE_umachi (TARGET_PLUS_MACD)
#define HAVE_maddsidi4_split (TARGET_PLUS_DMPY)
#define HAVE_macd (TARGET_PLUS_MACD)
#define HAVE_mac (TARGET_PLUS_DMPY)
#define HAVE_mac_r (TARGET_PLUS_DMPY)
#define HAVE_umaddsidi4_split (TARGET_PLUS_DMPY)
#define HAVE_macdu (TARGET_PLUS_MACD)
#define HAVE_macu (TARGET_PLUS_DMPY)
#define HAVE_macu_r (TARGET_PLUS_DMPY)
#define HAVE_mpyd_arcv2hs (TARGET_PLUS_MACD)
#define HAVE_mpydu_arcv2hs (TARGET_PLUS_MACD)
#define HAVE_mpyd_imm_arcv2hs (TARGET_PLUS_MACD)
#define HAVE_mpydu_imm_arcv2hs (TARGET_PLUS_MACD)
...
#define HAVE_addv4hi3 ((TARGET_PLUS_DMPY) && (TARGET_PLUS_QMACW))
#define HAVE_addv2si3 ((TARGET_PLUS_DMPY) && (TARGET_PLUS_QMACW))
#define HAVE_subv2hi3 (TARGET_PLUS_DMPY)
#define HAVE_subv4hi3 ((TARGET_PLUS_DMPY) && (TARGET_PLUS_QMACW))
#define HAVE_subv2si3 ((TARGET_PLUS_DMPY) && (TARGET_PLUS_QMACW))
...
#define HAVE_arc_vec_smac_v2hiv2si (TARGET_PLUS_MACD)
#define HAVE_arc_vec_umac_v2hiv2si (TARGET_PLUS_MACD)
#define HAVE_arc_vec_smac_v2hiv2si_zero (TARGET_PLUS_MACD)
#define HAVE_arc_vec_umac_v2hiv2si_zero (TARGET_PLUS_MACD)
...
#define HAVE_mulv2si3 (TARGET_MPYW)
#define HAVE_divv2si3 (TARGET_DIVREM)
#define HAVE_smaxv2si3 1
#define HAVE_sminv2si3 1
#define HAVE_reduc_plus_scal_v4hi (TARGET_PLUS_QMACW)
#define HAVE_reduc_plus_scal_v2si (TARGET_PLUS_DMPY)
#define HAVE_vec_duplicatev2si 1
#define HAVE_vec_duplicatev4hi (TARGET_BARREL_SHIFTER)
...
#define HAVE_mulsi3 (TARGET_ANY_MPY)
#define HAVE_mulsidi3 (TARGET_ANY_MPY)
#define HAVE_umulsi3_highpart (TARGET_MPY)
#define HAVE_umulsidi3 (TARGET_ANY_MPY)
...
#define HAVE_cstoresf4 ((TARGET_HARD_FLOAT || TARGET_OPTFPE) && (TARGET_FP_SP_BASE || TARGET_OPTFPE))
#define HAVE_cstoredf4 ((TARGET_HARD_FLOAT || TARGET_OPTFPE) && (TARGET_FP_DP_BASE || TARGET_OPTFPE))
...
#define HAVE_return (arc_can_use_return_insn ())
#define HAVE_doloop_end 1
#define HAVE_cpymemsi 1
#define HAVE_cbranchsf4 (TARGET_FP_SP_BASE || TARGET_OPTFPE)
#define HAVE_cbranchdf4 ((TARGET_FP_SP_BASE || TARGET_OPTFPE) && (TARGET_FP_DP_BASE || TARGET_OPTFPE))
...
#define HAVE_divsf3 (TARGET_FPX_QUARK || TARGET_FP_SP_SQRT)
#define HAVE_sqrtsf2 (TARGET_FPX_QUARK || TARGET_FP_SP_SQRT)
...
#define HAVE_maddhisi4 (TARGET_PLUS_MACD)
#define HAVE_umaddhisi4 (TARGET_PLUS_MACD)
#define HAVE_maddsidi4 (TARGET_PLUS_DMPY)
#define HAVE_umaddsidi4 (TARGET_PLUS_DMPY)
...
#define HAVE_movmisalignv2hi (unaligned_access)
#define HAVE_movv4hi 1
#define HAVE_movv2si 1
#define HAVE_movmisalignv4hi (unaligned_access)
#define HAVE_movmisalignv2si (unaligned_access)
#define HAVE_sdot_prodv2hi (TARGET_PLUS_DMPY)
#define HAVE_udot_prodv2hi (TARGET_PLUS_DMPY)
#define HAVE_sdot_prodv4hi (TARGET_PLUS_MACD)
#define HAVE_udot_prodv4hi (TARGET_PLUS_MACD)
#define HAVE_vec_widen_smult_lo_v4hi (TARGET_PLUS_QMACW)
#define HAVE_vec_widen_umult_lo_v4hi (TARGET_PLUS_QMACW)
#define HAVE_vec_widen_smult_hi_v4hi (TARGET_PLUS_QMACW)
#define HAVE_vec_widen_umult_hi_v4hi (TARGET_PLUS_QMACW)
#define HAVE_negv2hi2 (TARGET_PLUS_DMPY)
#define HAVE_negv4hi2 ((TARGET_PLUS_DMPY) && (TARGET_PLUS_QMACW))
#define HAVE_negv2si2 ((TARGET_PLUS_DMPY) && (TARGET_PLUS_QMACW))
...
#define HAVE_atomic_exchangesi (TARGET_ARC700 || TARGET_V2)
...
extern rtx        gen_mulsidi64                   (rtx, rtx, rtx);
...
extern rtx        gen_umulsidi64                  (rtx, rtx, rtx);
...
extern rtx        gen_sbc                         (rtx, rtx, rtx);
...
extern rtx        gen_lddiqi                      (rtx, rtx);
extern rtx        gen_lddihi                      (rtx, rtx);
extern rtx        gen_lddisi                      (rtx, rtx);
extern rtx        gen_lddidi                      (rtx, rtx);
extern rtx        gen_stdiqi                      (rtx, rtx);
extern rtx        gen_stdihi                      (rtx, rtx);
extern rtx        gen_stdisi                      (rtx, rtx);
extern rtx        gen_stdidi                      (rtx, rtx);
extern rtx        gen_trap_s                      (rtx);
extern rtx        gen_unimp_s                     (rtx);
extern rtx        gen_simple_return               (void);
extern rtx        gen_arc600_rtie                 (rtx);
extern rtx        gen_p_return_i                  (rtx);
extern rtx        gen_cbranchsi4_scratch          (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_arc_lp                      (rtx, rtx);
extern rtx        gen_loop_end                    (rtx, rtx);
extern rtx        gen_loop_fail                   (void);
extern rtx        gen_dbnz                        (rtx, rtx);
...
extern rtx        gen_maddsidi4_split             (rtx, rtx, rtx, rtx);
extern rtx        gen_macd                        (rtx, rtx, rtx);
extern rtx        gen_mac                         (rtx, rtx);
extern rtx        gen_mac_r                       (rtx, rtx, rtx);
extern rtx        gen_umaddsidi4_split            (rtx, rtx, rtx, rtx);
extern rtx        gen_macdu                       (rtx, rtx, rtx);
extern rtx        gen_macu                        (rtx, rtx);
extern rtx        gen_macu_r                      (rtx, rtx, rtx);
extern rtx        gen_mpyd_arcv2hs                (rtx, rtx, rtx);
extern rtx        gen_mpydu_arcv2hs               (rtx, rtx, rtx);
extern rtx        gen_mpyd_imm_arcv2hs            (rtx, rtx, rtx);
extern rtx        gen_mpydu_imm_arcv2hs           (rtx, rtx, rtx);
...
extern rtx        gen_arc_vec_smac_v2hiv2si       (rtx, rtx, rtx);
extern rtx        gen_arc_vec_umac_v2hiv2si       (rtx, rtx, rtx);
extern rtx        gen_arc_vec_smac_v2hiv2si_zero  (rtx, rtx);
extern rtx        gen_arc_vec_umac_v2hiv2si_zero  (rtx, rtx);
