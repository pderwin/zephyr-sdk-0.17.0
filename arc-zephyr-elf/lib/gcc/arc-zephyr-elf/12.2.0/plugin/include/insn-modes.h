...
#endif
  E_CC_ZNmode,             /* config/arc/arc-modes.def:25 */
#define HAVE_CC_ZNmode
#ifdef USE_ENUM_MODES
#define CC_ZNmode E_CC_ZNmode
#else
#define CC_ZNmode ((void) 0, E_CC_ZNmode)
#endif
  E_CC_Zmode,              /* config/arc/arc-modes.def:26 */
...
#endif
  E_CC_Cmode,              /* config/arc/arc-modes.def:27 */
...
#endif
  E_CC_FP_GTmode,          /* config/arc/arc-modes.def:28 */
#define HAVE_CC_FP_GTmode
#ifdef USE_ENUM_MODES
#define CC_FP_GTmode E_CC_FP_GTmode
#else
#define CC_FP_GTmode ((void) 0, E_CC_FP_GTmode)
#endif
  E_CC_FP_GEmode,          /* config/arc/arc-modes.def:29 */
#define HAVE_CC_FP_GEmode
#ifdef USE_ENUM_MODES
#define CC_FP_GEmode E_CC_FP_GEmode
#else
#define CC_FP_GEmode ((void) 0, E_CC_FP_GEmode)
#endif
  E_CC_FP_ORDmode,         /* config/arc/arc-modes.def:30 */
#define HAVE_CC_FP_ORDmode
#ifdef USE_ENUM_MODES
#define CC_FP_ORDmode E_CC_FP_ORDmode
#else
#define CC_FP_ORDmode ((void) 0, E_CC_FP_ORDmode)
#endif
  E_CC_FP_UNEQmode,        /* config/arc/arc-modes.def:31 */
#define HAVE_CC_FP_UNEQmode
#ifdef USE_ENUM_MODES
#define CC_FP_UNEQmode E_CC_FP_UNEQmode
#else
#define CC_FP_UNEQmode ((void) 0, E_CC_FP_UNEQmode)
#endif
  E_CC_FPXmode,            /* config/arc/arc-modes.def:32 */
#define HAVE_CC_FPXmode
#ifdef USE_ENUM_MODES
#define CC_FPXmode E_CC_FPXmode
#else
#define CC_FPXmode ((void) 0, E_CC_FPXmode)
#endif
  E_CC_FPUmode,            /* config/arc/arc-modes.def:40 */
#define HAVE_CC_FPUmode
#ifdef USE_ENUM_MODES
#define CC_FPUmode E_CC_FPUmode
#else
#define CC_FPUmode ((void) 0, E_CC_FPUmode)
#endif
  E_CC_FPUEmode,           /* config/arc/arc-modes.def:41 */
#define HAVE_CC_FPUEmode
#ifdef USE_ENUM_MODES
#define CC_FPUEmode E_CC_FPUEmode
#else
#define CC_FPUEmode ((void) 0, E_CC_FPUEmode)
#endif
  E_CC_FPU_UNEQmode,       /* config/arc/arc-modes.def:42 */
#define HAVE_CC_FPU_UNEQmode
#ifdef USE_ENUM_MODES
#define CC_FPU_UNEQmode E_CC_FPU_UNEQmode
#else
#define CC_FPU_UNEQmode ((void) 0, E_CC_FPU_UNEQmode)
#endif
...
#endif
  E_V4QImode,              /* config/arc/arc-modes.def:35 */
...
#endif
  E_V2HImode,              /* config/arc/arc-modes.def:35 */
...
#endif
  E_V8QImode,              /* config/arc/arc-modes.def:36 */
...
#endif
  E_V4HImode,              /* config/arc/arc-modes.def:36 */
...
#endif
  E_V2SImode,              /* config/arc/arc-modes.def:36 */
...
#endif
  E_V16QImode,             /* config/arc/arc-modes.def:37 */
...
#endif
  E_V8HImode,              /* config/arc/arc-modes.def:37 */
...
#endif
  E_V4SImode,              /* config/arc/arc-modes.def:37 */
...
#endif
  E_V2DImode,              /* config/arc/arc-modes.def:37 */
