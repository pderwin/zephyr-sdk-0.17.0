...
#endif
#ifdef GENERATOR_FILE
extern const char *nios2_gprel_sec;
#else
  const char *x_nios2_gprel_sec;
#define nios2_gprel_sec global_options.x_nios2_gprel_sec
#endif
#ifdef GENERATOR_FILE
extern const char *nios2_r0rel_sec;
#else
  const char *x_nios2_r0rel_sec;
#define nios2_r0rel_sec global_options.x_nios2_r0rel_sec
#endif
#ifdef GENERATOR_FILE
...
#define MASK_HAS_BMX (1U << 0)
#define MASK_BYPASS_CACHE (1U << 1)
#define MASK_BYPASS_CACHE_VOLATILE (1U << 2)
#define MASK_HAS_CDX (1U << 3)
#define MASK_BIG_ENDIAN (1U << 4)
#define MASK_FAST_SW_DIV (1U << 5)
#define MASK_HAS_DIV (1U << 6)
#define MASK_HAS_MUL (1U << 7)
#define MASK_HAS_MULX (1U << 8)

/* HAS_BMX mask */
#define TARGET_HAS_BMX ((target_flags & MASK_HAS_BMX) != 0)
#define TARGET_HAS_BMX_P(target_flags) (((target_flags) & MASK_HAS_BMX) != 0)
#define TARGET_EXPLICIT_HAS_BMX_P(opts) ((opts->x_target_flags_explicit & MASK_HAS_BMX) != 0)
#define SET_TARGET_HAS_BMX(opts) opts->x_target_flags |= MASK_HAS_BMX
/* BYPASS_CACHE mask */
...
#define TARGET_EXPLICIT_BYPASS_CACHE_P(opts) ((opts->x_target_flags_explicit & MASK_BYPASS_CACHE) != 0)
#define SET_TARGET_BYPASS_CACHE(opts) opts->x_target_flags |= MASK_BYPASS_CACHE
/* BYPASS_CACHE_VOLATILE mask */
...
#define TARGET_EXPLICIT_BYPASS_CACHE_VOLATILE_P(opts) ((opts->x_target_flags_explicit & MASK_BYPASS_CACHE_VOLATILE) != 0)
#define SET_TARGET_BYPASS_CACHE_VOLATILE(opts) opts->x_target_flags |= MASK_BYPASS_CACHE_VOLATILE
/* HAS_CDX mask */
#define TARGET_HAS_CDX ((target_flags & MASK_HAS_CDX) != 0)
#define TARGET_HAS_CDX_P(target_flags) (((target_flags) & MASK_HAS_CDX) != 0)
#define TARGET_EXPLICIT_HAS_CDX_P(opts) ((opts->x_target_flags_explicit & MASK_HAS_CDX) != 0)
#define SET_TARGET_HAS_CDX(opts) opts->x_target_flags |= MASK_HAS_CDX
/* BIG_ENDIAN mask */
...
#define TARGET_EXPLICIT_FAST_SW_DIV_P(opts) ((opts->x_target_flags_explicit & MASK_FAST_SW_DIV) != 0)
#define SET_TARGET_FAST_SW_DIV(opts) opts->x_target_flags |= MASK_FAST_SW_DIV
/* HAS_DIV mask */
#define TARGET_HAS_DIV ((target_flags & MASK_HAS_DIV) != 0)
#define TARGET_HAS_DIV_P(target_flags) (((target_flags) & MASK_HAS_DIV) != 0)
#define TARGET_EXPLICIT_HAS_DIV_P(opts) ((opts->x_target_flags_explicit & MASK_HAS_DIV) != 0)
#define SET_TARGET_HAS_DIV(opts) opts->x_target_flags |= MASK_HAS_DIV
/* HAS_MUL mask */
#define TARGET_HAS_MUL ((target_flags & MASK_HAS_MUL) != 0)
#define TARGET_HAS_MUL_P(target_flags) (((target_flags) & MASK_HAS_MUL) != 0)
#define TARGET_EXPLICIT_HAS_MUL_P(opts) ((opts->x_target_flags_explicit & MASK_HAS_MUL) != 0)
#define SET_TARGET_HAS_MUL(opts) opts->x_target_flags |= MASK_HAS_MUL
/* HAS_MULX mask */
#define TARGET_HAS_MULX ((target_flags & MASK_HAS_MULX) != 0)
#define TARGET_HAS_MULX_P(target_flags) (((target_flags) & MASK_HAS_MULX) != 0)
#define TARGET_EXPLICIT_HAS_MULX_P(opts) ((opts->x_target_flags_explicit & MASK_HAS_MULX) != 0)
#define SET_TARGET_HAS_MULX(opts) opts->x_target_flags |= MASK_HAS_MULX
...
enum opt_code
{
  ...
  OPT_list = 1764,                           /* -list */
  OPT_march_ = 1765,                         /* -march= */
  OPT_mbmx = 1766,                           /* -mbmx */
  OPT_mbypass_cache = 1767,                  /* -mbypass-cache */
  OPT_mcache_volatile = 1768,                /* -mcache-volatile */
  OPT_mcdx = 1769,                           /* -mcdx */
  OPT_mcustom_fabsd_ = 1770,                 /* -mcustom-fabsd= */
  OPT_mcustom_fabss_ = 1771,                 /* -mcustom-fabss= */
  OPT_mcustom_faddd_ = 1772,                 /* -mcustom-faddd= */
  OPT_mcustom_fadds_ = 1773,                 /* -mcustom-fadds= */
  OPT_mcustom_fatand_ = 1774,                /* -mcustom-fatand= */
  OPT_mcustom_fatans_ = 1775,                /* -mcustom-fatans= */
  OPT_mcustom_fcmpeqd_ = 1776,               /* -mcustom-fcmpeqd= */
  OPT_mcustom_fcmpeqs_ = 1777,               /* -mcustom-fcmpeqs= */
  OPT_mcustom_fcmpged_ = 1778,               /* -mcustom-fcmpged= */
  OPT_mcustom_fcmpges_ = 1779,               /* -mcustom-fcmpges= */
  OPT_mcustom_fcmpgtd_ = 1780,               /* -mcustom-fcmpgtd= */
  OPT_mcustom_fcmpgts_ = 1781,               /* -mcustom-fcmpgts= */
  OPT_mcustom_fcmpled_ = 1782,               /* -mcustom-fcmpled= */
  OPT_mcustom_fcmples_ = 1783,               /* -mcustom-fcmples= */
  OPT_mcustom_fcmpltd_ = 1784,               /* -mcustom-fcmpltd= */
  OPT_mcustom_fcmplts_ = 1785,               /* -mcustom-fcmplts= */
  OPT_mcustom_fcmpned_ = 1786,               /* -mcustom-fcmpned= */
  OPT_mcustom_fcmpnes_ = 1787,               /* -mcustom-fcmpnes= */
  OPT_mcustom_fcosd_ = 1788,                 /* -mcustom-fcosd= */
  OPT_mcustom_fcoss_ = 1789,                 /* -mcustom-fcoss= */
  OPT_mcustom_fdivd_ = 1790,                 /* -mcustom-fdivd= */
  OPT_mcustom_fdivs_ = 1791,                 /* -mcustom-fdivs= */
  OPT_mcustom_fexpd_ = 1792,                 /* -mcustom-fexpd= */
  OPT_mcustom_fexps_ = 1793,                 /* -mcustom-fexps= */
  OPT_mcustom_fextsd_ = 1794,                /* -mcustom-fextsd= */
  OPT_mcustom_fixdi_ = 1795,                 /* -mcustom-fixdi= */
  OPT_mcustom_fixdu_ = 1796,                 /* -mcustom-fixdu= */
  OPT_mcustom_fixsi_ = 1797,                 /* -mcustom-fixsi= */
  OPT_mcustom_fixsu_ = 1798,                 /* -mcustom-fixsu= */
  OPT_mcustom_floatid_ = 1799,               /* -mcustom-floatid= */
  OPT_mcustom_floatis_ = 1800,               /* -mcustom-floatis= */
  OPT_mcustom_floatud_ = 1801,               /* -mcustom-floatud= */
  OPT_mcustom_floatus_ = 1802,               /* -mcustom-floatus= */
  OPT_mcustom_flogd_ = 1803,                 /* -mcustom-flogd= */
  OPT_mcustom_flogs_ = 1804,                 /* -mcustom-flogs= */
  OPT_mcustom_fmaxd_ = 1805,                 /* -mcustom-fmaxd= */
  OPT_mcustom_fmaxs_ = 1806,                 /* -mcustom-fmaxs= */
  OPT_mcustom_fmind_ = 1807,                 /* -mcustom-fmind= */
  OPT_mcustom_fmins_ = 1808,                 /* -mcustom-fmins= */
  OPT_mcustom_fmuld_ = 1809,                 /* -mcustom-fmuld= */
  OPT_mcustom_fmuls_ = 1810,                 /* -mcustom-fmuls= */
  OPT_mcustom_fnegd_ = 1811,                 /* -mcustom-fnegd= */
  OPT_mcustom_fnegs_ = 1812,                 /* -mcustom-fnegs= */
  OPT_mcustom_fpu_cfg_ = 1813,               /* -mcustom-fpu-cfg= */
  OPT_mcustom_frdxhi_ = 1814,                /* -mcustom-frdxhi= */
  OPT_mcustom_frdxlo_ = 1815,                /* -mcustom-frdxlo= */
  OPT_mcustom_frdy_ = 1816,                  /* -mcustom-frdy= */
  OPT_mcustom_fsind_ = 1817,                 /* -mcustom-fsind= */
  OPT_mcustom_fsins_ = 1818,                 /* -mcustom-fsins= */
  OPT_mcustom_fsqrtd_ = 1819,                /* -mcustom-fsqrtd= */
  OPT_mcustom_fsqrts_ = 1820,                /* -mcustom-fsqrts= */
  OPT_mcustom_fsubd_ = 1821,                 /* -mcustom-fsubd= */
  OPT_mcustom_fsubs_ = 1822,                 /* -mcustom-fsubs= */
  OPT_mcustom_ftand_ = 1823,                 /* -mcustom-ftand= */
  OPT_mcustom_ftans_ = 1824,                 /* -mcustom-ftans= */
  OPT_mcustom_ftruncds_ = 1825,              /* -mcustom-ftruncds= */
  OPT_mcustom_fwrx_ = 1826,                  /* -mcustom-fwrx= */
  OPT_mcustom_fwry_ = 1827,                  /* -mcustom-fwry= */
  OPT_mcustom_round_ = 1828,                 /* -mcustom-round= */
  OPT_meb = 1829,                            /* -meb */
  OPT_mel = 1830,                            /* -mel */
  OPT_mfast_sw_div = 1831,                   /* -mfast-sw-div */
  OPT_mgpopt = 1832,                         /* -mgpopt */
  OPT_mgpopt_ = 1833,                        /* -mgpopt= */
  OPT_mgprel_sec_ = 1834,                    /* -mgprel-sec= */
  OPT_mhal = 1835,                           /* -mhal */
  OPT_mhw_div = 1836,                        /* -mhw-div */
  OPT_mhw_mul = 1837,                        /* -mhw-mul */
  OPT_mhw_mulx = 1838,                       /* -mhw-mulx */
  OPT_mno_cache_volatile = 1839,             /* -mno-cache-volatile */
  OPT_mno_custom_fabsd = 1840,               /* -mno-custom-fabsd */
  OPT_mno_custom_fabss = 1841,               /* -mno-custom-fabss */
  OPT_mno_custom_faddd = 1842,               /* -mno-custom-faddd */
  OPT_mno_custom_fadds = 1843,               /* -mno-custom-fadds */
  OPT_mno_custom_fatand = 1844,              /* -mno-custom-fatand */
  OPT_mno_custom_fatans = 1845,              /* -mno-custom-fatans */
  OPT_mno_custom_fcmpeqd = 1846,             /* -mno-custom-fcmpeqd */
  OPT_mno_custom_fcmpeqs = 1847,             /* -mno-custom-fcmpeqs */
  OPT_mno_custom_fcmpged = 1848,             /* -mno-custom-fcmpged */
  OPT_mno_custom_fcmpges = 1849,             /* -mno-custom-fcmpges */
  OPT_mno_custom_fcmpgtd = 1850,             /* -mno-custom-fcmpgtd */
  OPT_mno_custom_fcmpgts = 1851,             /* -mno-custom-fcmpgts */
  OPT_mno_custom_fcmpled = 1852,             /* -mno-custom-fcmpled */
  OPT_mno_custom_fcmples = 1853,             /* -mno-custom-fcmples */
  OPT_mno_custom_fcmpltd = 1854,             /* -mno-custom-fcmpltd */
  OPT_mno_custom_fcmplts = 1855,             /* -mno-custom-fcmplts */
  OPT_mno_custom_fcmpned = 1856,             /* -mno-custom-fcmpned */
  OPT_mno_custom_fcmpnes = 1857,             /* -mno-custom-fcmpnes */
  OPT_mno_custom_fcosd = 1858,               /* -mno-custom-fcosd */
  OPT_mno_custom_fcoss = 1859,               /* -mno-custom-fcoss */
  OPT_mno_custom_fdivd = 1860,               /* -mno-custom-fdivd */
  OPT_mno_custom_fdivs = 1861,               /* -mno-custom-fdivs */
  OPT_mno_custom_fexpd = 1862,               /* -mno-custom-fexpd */
  OPT_mno_custom_fexps = 1863,               /* -mno-custom-fexps */
  OPT_mno_custom_fextsd = 1864,              /* -mno-custom-fextsd */
  OPT_mno_custom_fixdi = 1865,               /* -mno-custom-fixdi */
  OPT_mno_custom_fixdu = 1866,               /* -mno-custom-fixdu */
  OPT_mno_custom_fixsi = 1867,               /* -mno-custom-fixsi */
  OPT_mno_custom_fixsu = 1868,               /* -mno-custom-fixsu */
  OPT_mno_custom_floatid = 1869,             /* -mno-custom-floatid */
  OPT_mno_custom_floatis = 1870,             /* -mno-custom-floatis */
  OPT_mno_custom_floatud = 1871,             /* -mno-custom-floatud */
  OPT_mno_custom_floatus = 1872,             /* -mno-custom-floatus */
  OPT_mno_custom_flogd = 1873,               /* -mno-custom-flogd */
  OPT_mno_custom_flogs = 1874,               /* -mno-custom-flogs */
  OPT_mno_custom_fmaxd = 1875,               /* -mno-custom-fmaxd */
  OPT_mno_custom_fmaxs = 1876,               /* -mno-custom-fmaxs */
  OPT_mno_custom_fmind = 1877,               /* -mno-custom-fmind */
  OPT_mno_custom_fmins = 1878,               /* -mno-custom-fmins */
  OPT_mno_custom_fmuld = 1879,               /* -mno-custom-fmuld */
  OPT_mno_custom_fmuls = 1880,               /* -mno-custom-fmuls */
  OPT_mno_custom_fnegd = 1881,               /* -mno-custom-fnegd */
  OPT_mno_custom_fnegs = 1882,               /* -mno-custom-fnegs */
  OPT_mno_custom_frdxhi = 1883,              /* -mno-custom-frdxhi */
  OPT_mno_custom_frdxlo = 1884,              /* -mno-custom-frdxlo */
  OPT_mno_custom_frdy = 1885,                /* -mno-custom-frdy */
  OPT_mno_custom_fsind = 1886,               /* -mno-custom-fsind */
  OPT_mno_custom_fsins = 1887,               /* -mno-custom-fsins */
  OPT_mno_custom_fsqrtd = 1888,              /* -mno-custom-fsqrtd */
  OPT_mno_custom_fsqrts = 1889,              /* -mno-custom-fsqrts */
  OPT_mno_custom_fsubd = 1890,               /* -mno-custom-fsubd */
  OPT_mno_custom_fsubs = 1891,               /* -mno-custom-fsubs */
  OPT_mno_custom_ftand = 1892,               /* -mno-custom-ftand */
  OPT_mno_custom_ftans = 1893,               /* -mno-custom-ftans */
  OPT_mno_custom_ftruncds = 1894,            /* -mno-custom-ftruncds */
  OPT_mno_custom_fwrx = 1895,                /* -mno-custom-fwrx */
  OPT_mno_custom_fwry = 1896,                /* -mno-custom-fwry */
  OPT_mno_custom_round = 1897,               /* -mno-custom-round */
  OPT_mno_gpopt = 1898,                      /* -mno-gpopt */
  OPT_mr0rel_sec_ = 1899,                    /* -mr0rel-sec= */
  OPT_msmallc = 1900,                        /* -msmallc */
  OPT_msys_crt0_ = 1901,                     /* -msys-crt0= */
  OPT_msys_lib_ = 1902,                      /* -msys-lib= */
  OPT_n = 1903,                              /* -n */
  OPT_name_sort = 1904,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1905,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1906,              /* -no-integrated-cpp */
  OPT_no_pie = 1907,                         /* -no-pie */
  OPT_nocpp = 1908,                          /* -nocpp */
  OPT_nodefaultlibs = 1909,                  /* -nodefaultlibs */
  OPT_nolibc = 1910,                         /* -nolibc */
  OPT_nophoboslib = 1911,                    /* -nophoboslib */
  OPT_nostartfiles = 1912,                   /* -nostartfiles */
  OPT_nostdinc = 1913,                       /* -nostdinc */
  OPT_nostdinc__ = 1914,                     /* -nostdinc++ */
  OPT_nostdlib = 1915,                       /* -nostdlib */
  OPT_o = 1916,                              /* -o */
  ...
  OPT_r = 1938,                              /* -r */
  OPT_remap = 1939,                          /* -remap */
  OPT_reverse_sort = 1940,                   /* -reverse-sort */
  OPT_s = 1941,                              /* -s */
  OPT_save_temps = 1942,                     /* -save-temps */
  OPT_save_temps_ = 1943,                    /* -save-temps= */
  OPT_shared = 1944,                         /* -shared */
  OPT_shared_libgcc = 1945,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1946,               /* -shared-libphobos */
  OPT_size_sort = 1947,                      /* -size-sort */
  /* OPT_specs = 1948, */                    /* -specs */
  OPT_specs_ = 1949,                         /* -specs= */
  OPT_static = 1950,                         /* -static */
  OPT_static_libasan = 1951,                 /* -static-libasan */
  OPT_static_libgcc = 1952,                  /* -static-libgcc */
  OPT_static_libgfortran = 1953,             /* -static-libgfortran */
  OPT_static_libgo = 1954,                   /* -static-libgo */
  OPT_static_libhwasan = 1955,               /* -static-libhwasan */
  OPT_static_liblsan = 1956,                 /* -static-liblsan */
  OPT_static_libmpx = 1957,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1958,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1959,               /* -static-libphobos */
  OPT_static_libstdc__ = 1960,               /* -static-libstdc++ */
  OPT_static_libtsan = 1961,                 /* -static-libtsan */
  OPT_static_libubsan = 1962,                /* -static-libubsan */
  OPT_static_pie = 1963,                     /* -static-pie */
  /* OPT_std_c__03 = 1964, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1965, */                /* -std=c++0x */
  OPT_std_c__11 = 1966,                      /* -std=c++11 */
  OPT_std_c__14 = 1967,                      /* -std=c++14 */
  OPT_std_c__17 = 1968,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1969, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1970, */                /* -std=c++1z */
  OPT_std_c__20 = 1971,                      /* -std=c++20 */
  OPT_std_c__23 = 1972,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1973, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1974, */                /* -std=c++2b */
  OPT_std_c__98 = 1975,                      /* -std=c++98 */
  OPT_std_c11 = 1976,                        /* -std=c11 */
  OPT_std_c17 = 1977,                        /* -std=c17 */
  /* OPT_std_c18 = 1978, */                  /* -std=c18 */
  /* OPT_std_c1x = 1979, */                  /* -std=c1x */
  OPT_std_c2x = 1980,                        /* -std=c2x */
  /* OPT_std_c89 = 1981, */                  /* -std=c89 */
  OPT_std_c90 = 1982,                        /* -std=c90 */
  OPT_std_c99 = 1983,                        /* -std=c99 */
  /* OPT_std_c9x = 1984, */                  /* -std=c9x */
  OPT_std_f2003 = 1985,                      /* -std=f2003 */
  OPT_std_f2008 = 1986,                      /* -std=f2008 */
  OPT_std_f2008ts = 1987,                    /* -std=f2008ts */
  OPT_std_f2018 = 1988,                      /* -std=f2018 */
  OPT_std_f95 = 1989,                        /* -std=f95 */
  OPT_std_gnu = 1990,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1991, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1992, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1993,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1994,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1995,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1996, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1997, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1998,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1999,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2000, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2001, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2002,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2003,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2004,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2005, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2006, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2007,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2008, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2009,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2010,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2011, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2012, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2013,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2014, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2015, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2016, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2017, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2018, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2019,                     /* -std=legacy */
  OPT_stdlib_ = 2020,                        /* -stdlib= */
  OPT_symbol_ = 2021,                        /* -symbol= */
  OPT_symbolic = 2022,                       /* -symbolic */
  OPT_t = 2023,                              /* -t */
  OPT_time = 2024,                           /* -time */
  OPT_time_ = 2025,                          /* -time= */
  OPT_traditional = 2026,                    /* -traditional */
  OPT_traditional_cpp = 2027,                /* -traditional-cpp */
  OPT_tree_stats = 2028,                     /* -tree-stats */
  OPT_trigraphs = 2029,                      /* -trigraphs */
  OPT_type_stats = 2030,                     /* -type-stats */
  OPT_u = 2031,                              /* -u */
  OPT_undef = 2032,                          /* -undef */
  OPT_v = 2033,                              /* -v */
  OPT_version = 2034,                        /* -version */
  OPT_w = 2035,                              /* -w */
  OPT_wrapper = 2036,                        /* -wrapper */
  OPT_x = 2037,                              /* -x */
  OPT_z = 2038,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
