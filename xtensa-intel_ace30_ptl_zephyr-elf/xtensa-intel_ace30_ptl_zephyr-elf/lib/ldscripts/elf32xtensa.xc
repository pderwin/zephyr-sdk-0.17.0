...
ENTRY(_start)
SEARCH_DIR("=/__w/_temp/workspace/output/xtensa-intel_ace30_ptl_zephyr-elf/xtensa-intel_ace30_ptl_zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
