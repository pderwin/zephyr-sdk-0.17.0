...
ENTRY(_start)
SEARCH_DIR("=/__w/_temp/workspace/output/xtensa-nxp_imx8m_adsp_zephyr-elf/xtensa-nxp_imx8m_adsp_zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
