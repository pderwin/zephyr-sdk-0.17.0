...
ENTRY(_start)
SEARCH_DIR("=/__w/_temp/workspace/output/xtensa-amd_acp_6_0_adsp_zephyr-elf/xtensa-amd_acp_6_0_adsp_zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
