...
#define HAVE_ATTR_cpu_feature 1
extern enum attr_cpu_feature get_attr_cpu_feature (rtx_insn *);

#define HAVE_ATTR_lra 1
extern enum attr_lra get_attr_lra (rtx_insn *);
...
#define HAVE_ATTR_subtype 1
extern enum attr_subtype get_attr_subtype (rtx_insn *);

#define HAVE_ATTR_empty_delay_slot 1
extern enum attr_empty_delay_slot get_attr_empty_delay_slot (rtx_insn *);

#define HAVE_ATTR_emit_cbcond_nop 1
extern enum attr_emit_cbcond_nop get_attr_emit_cbcond_nop (rtx_insn *);

#define HAVE_ATTR_branch_type 1
extern enum attr_branch_type get_attr_branch_type (rtx_insn *);

#define HAVE_ATTR_pic 1
extern enum attr_pic get_attr_pic (rtx_insn *);

#define HAVE_ATTR_calls_alloca 1
extern enum attr_calls_alloca get_attr_calls_alloca (rtx_insn *);

#define HAVE_ATTR_calls_eh_return 1
extern enum attr_calls_eh_return get_attr_calls_eh_return (rtx_insn *);

#define HAVE_ATTR_leaf_function 1
extern enum attr_leaf_function get_attr_leaf_function (rtx_insn *);

#define HAVE_ATTR_delayed_branch 1
extern enum attr_delayed_branch get_attr_delayed_branch (rtx_insn *);

#define HAVE_ATTR_flat 1
extern enum attr_flat get_attr_flat (rtx_insn *);

#define HAVE_ATTR_fix_ut699 1
extern enum attr_fix_ut699 get_attr_fix_ut699 (rtx_insn *);

#define HAVE_ATTR_fix_b2bst 1
extern enum attr_fix_b2bst get_attr_fix_b2bst (rtx_insn *);

#define HAVE_ATTR_fix_lost_divsqrt 1
extern enum attr_fix_lost_divsqrt get_attr_fix_lost_divsqrt (rtx_insn *);

#define HAVE_ATTR_fix_gr712rc 1
extern enum attr_fix_gr712rc get_attr_fix_gr712rc (rtx_insn *);
...
#define HAVE_ATTR_fptype 1
extern enum attr_fptype get_attr_fptype (rtx_insn *);

#define HAVE_ATTR_fptype_ut699 1
extern enum attr_fptype_ut699 get_attr_fptype_ut699 (rtx_insn *);

#define HAVE_ATTR_us3load_type 1
extern enum attr_us3load_type get_attr_us3load_type (rtx_insn *);

#define HAVE_ATTR_tls_delay_slot 1
extern enum attr_tls_delay_slot get_attr_tls_delay_slot (rtx_insn *);

#define HAVE_ATTR_in_sibcall_delay 1
extern enum attr_in_sibcall_delay get_attr_in_sibcall_delay (rtx_insn *);

#define HAVE_ATTR_in_return_delay 1
extern enum attr_in_return_delay get_attr_in_return_delay (rtx_insn *);

#define HAVE_ATTR_in_branch_delay 1
extern enum attr_in_branch_delay get_attr_in_branch_delay (rtx_insn *);

#define HAVE_ATTR_in_integer_branch_annul_delay 1
extern enum attr_in_integer_branch_annul_delay get_attr_in_integer_branch_annul_delay (rtx_insn *);
