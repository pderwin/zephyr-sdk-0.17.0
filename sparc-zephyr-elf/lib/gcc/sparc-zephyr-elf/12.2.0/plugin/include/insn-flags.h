...
#define HAVE_speculation_barrier (TARGET_V9)
...
#define HAVE_trap 1
#define HAVE_tgd_hi22si 1
#define HAVE_tgd_lo10si 1
#define HAVE_tgd_addsi 1
#define HAVE_tgd_callsi 1
#define HAVE_tldm_hi22si 1
#define HAVE_tldm_lo10si 1
#define HAVE_tldm_addsi 1
#define HAVE_tldm_callsi 1
#define HAVE_tldo_hix22si 1
#define HAVE_tldo_lox10si 1
#define HAVE_tldo_addsi 1
#define HAVE_tie_hi22si 1
#define HAVE_tie_lo10si 1
#define HAVE_tie_ld32 1
#define HAVE_tie_addsi 1
#define HAVE_tle_hix22si 1
#define HAVE_tle_lox10si 1
#define HAVE_stack_protect_set32 1
#define HAVE_stack_protect_test32 1
...
#define HAVE_dictunpack32 (TARGET_VIS4B)
#define HAVE_dictunpack16 (TARGET_VIS4B)
#define HAVE_dictunpack8 (TARGET_VIS4B)
#define HAVE_fpcmple32sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpgt32sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpeq32sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpne32sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmple16sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpgt16sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpeq16sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpne16sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmple8sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpgt8sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpeq8sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpne8sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpule32sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpugt32sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpule16sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpugt16sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpule8sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpugt8sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpde32sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpde16sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpde8sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpur32sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpur16sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_fpcmpur8sishl ((TARGET_VIS4B) && (TARGET_ARCH32))
#define HAVE_atomic_loaddi_1 1
#define HAVE_atomic_storedi_1 1
#define HAVE_atomic_compare_and_swap_leon3_1 (TARGET_LEON3)
...
#define HAVE_mulsi3 (TARGET_HARD_MUL || TARGET_ARCH64)
...
#define HAVE_vec_initv1sisi (TARGET_VIS)
#define HAVE_vec_initv2hihi (TARGET_VIS)
#define HAVE_vec_initv4qiqi (TARGET_VIS)
#define HAVE_vec_initv1didi (TARGET_VIS)
#define HAVE_vec_initv2sisi (TARGET_VIS)
#define HAVE_vec_initv4hihi (TARGET_VIS)
#define HAVE_vec_initv8qiqi (TARGET_VIS)
...
extern rtx        gen_tgd_hi22si                      (rtx, rtx);
static inline rtx gen_tgd_hi22di                      (rtx, rtx);
static inline rtx
gen_tgd_hi22di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_tgd_lo10si                      (rtx, rtx, rtx);
static inline rtx gen_tgd_lo10di                      (rtx, rtx, rtx);
static inline rtx
gen_tgd_lo10di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_tgd_addsi                       (rtx, rtx, rtx, rtx);
static inline rtx gen_tgd_adddi                       (rtx, rtx, rtx, rtx);
static inline rtx
gen_tgd_adddi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_tgd_callsi                      (rtx, rtx, rtx, rtx);
static inline rtx gen_tgd_calldi                      (rtx, rtx, rtx, rtx);
static inline rtx
gen_tgd_calldi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_tldm_hi22si                     (rtx);
static inline rtx gen_tldm_hi22di                     (rtx);
static inline rtx
gen_tldm_hi22di(rtx ARG_UNUSED (a))
{
  return 0;
}
extern rtx        gen_tldm_lo10si                     (rtx, rtx);
static inline rtx gen_tldm_lo10di                     (rtx, rtx);
static inline rtx
gen_tldm_lo10di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_tldm_addsi                      (rtx, rtx, rtx);
static inline rtx gen_tldm_adddi                      (rtx, rtx, rtx);
static inline rtx
gen_tldm_adddi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_tldm_callsi                     (rtx, rtx, rtx);
static inline rtx gen_tldm_calldi                     (rtx, rtx, rtx);
static inline rtx
gen_tldm_calldi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_tldo_hix22si                    (rtx, rtx);
static inline rtx gen_tldo_hix22di                    (rtx, rtx);
static inline rtx
gen_tldo_hix22di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_tldo_lox10si                    (rtx, rtx, rtx);
static inline rtx gen_tldo_lox10di                    (rtx, rtx, rtx);
static inline rtx
gen_tldo_lox10di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_tldo_addsi                      (rtx, rtx, rtx, rtx);
static inline rtx gen_tldo_adddi                      (rtx, rtx, rtx, rtx);
static inline rtx
gen_tldo_adddi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_tie_hi22si                      (rtx, rtx);
static inline rtx gen_tie_hi22di                      (rtx, rtx);
static inline rtx
gen_tie_hi22di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_tie_lo10si                      (rtx, rtx, rtx);
static inline rtx gen_tie_lo10di                      (rtx, rtx, rtx);
static inline rtx
gen_tie_lo10di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_tie_addsi                       (rtx, rtx, rtx, rtx);
static inline rtx gen_tie_adddi                       (rtx, rtx, rtx, rtx);
static inline rtx
gen_tie_adddi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_tle_hix22si                     (rtx, rtx);
static inline rtx gen_tle_hix22di                     (rtx, rtx);
static inline rtx
gen_tle_hix22di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_tle_lox10si                     (rtx, rtx, rtx);
static inline rtx gen_tle_lox10di                     (rtx, rtx, rtx);
static inline rtx
gen_tle_lox10di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_stack_protect_set32             (rtx, rtx);
static inline rtx gen_stack_protect_set64             (rtx, rtx);
static inline rtx
gen_stack_protect_set64(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_stack_protect_test32            (rtx, rtx);
static inline rtx gen_stack_protect_test64            (rtx, rtx, rtx);
static inline rtx
gen_stack_protect_test64(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_dictunpack32                    (rtx, rtx, rtx);
extern rtx        gen_dictunpack16                    (rtx, rtx, rtx);
extern rtx        gen_dictunpack8                     (rtx, rtx, rtx);
extern rtx        gen_fpcmple32sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpgt32sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpeq32sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpne32sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmple16sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpgt16sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpeq16sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpne16sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmple8sishl                   (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpgt8sishl                   (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpeq8sishl                   (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpne8sishl                   (rtx, rtx, rtx, rtx);
static inline rtx gen_fpcmple32dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmple32dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpgt32dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpgt32dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpeq32dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpeq32dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpne32dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpne32dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmple16dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmple16dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpgt16dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpgt16dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpeq16dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpeq16dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpne16dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpne16dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmple8dishl                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmple8dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpgt8dishl                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpgt8dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpeq8dishl                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpeq8dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpne8dishl                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpne8dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_fpcmpule32sishl                 (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpugt32sishl                 (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpule16sishl                 (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpugt16sishl                 (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpule8sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpugt8sishl                  (rtx, rtx, rtx, rtx);
static inline rtx gen_fpcmpule32dishl                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpule32dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpugt32dishl                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpugt32dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpule16dishl                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpule16dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpugt16dishl                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpugt16dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpule8dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpule8dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpugt8dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpugt8dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_fpcmpde32sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpde16sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpde8sishl                   (rtx, rtx, rtx, rtx);
static inline rtx gen_fpcmpde32dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpde32dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpde16dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpde16dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpde8dishl                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpde8dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_fpcmpur32sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpur16sishl                  (rtx, rtx, rtx, rtx);
extern rtx        gen_fpcmpur8sishl                   (rtx, rtx, rtx, rtx);
static inline rtx gen_fpcmpur32dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpur32dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpur16dishl                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpur16dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_fpcmpur8dishl                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_fpcmpur8dishl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_atomic_loaddi_1                 (rtx, rtx);
extern rtx        gen_atomic_storedi_1                (rtx, rtx);
extern rtx        gen_atomic_compare_and_swap_leon3_1 (rtx, rtx, rtx, rtx);
...
static inline rtx gen_builtin_setjmp_receiver         (rtx);
static inline rtx
gen_builtin_setjmp_receiver(rtx ARG_UNUSED (a))
{
  return 0;
}
...
extern rtx        gen_vec_initv1sisi                  (rtx, rtx);
extern rtx        gen_vec_initv2hihi                  (rtx, rtx);
extern rtx        gen_vec_initv4qiqi                  (rtx, rtx);
extern rtx        gen_vec_initv1didi                  (rtx, rtx);
